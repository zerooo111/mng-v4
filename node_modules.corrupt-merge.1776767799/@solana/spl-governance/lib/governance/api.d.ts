...
import { Governance, GovernanceAccount, Proposal, Realm, TokenOwnerRecord, VoteRecord, RealmConfigAccount, ProposalDeposit } from './accounts';
...
export declare function getVoteRecord(connection: Connection, voteRecordPk: PublicKey): Promise<ProgramAccount<VoteRecord>>;
 ...
 * @returns
 */
export declare function getProposalDepositsByDepositPayer(connection: Connection, programId: PublicKey, depositPayer: PublicKey): Promise<ProgramAccount<ProposalDeposit>[]>;
