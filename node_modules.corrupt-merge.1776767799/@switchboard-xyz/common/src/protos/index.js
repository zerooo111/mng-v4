...
export const oracle_job = ($root.oracle_job = (() => {
  ...
  oracle_job.OracleJob = (function () {
    ...
    /**
     * Encodes the specified OracleJob message. Does not implicitly {@apilink oracle_job.OracleJob.verify|verify} messages.
     * @function encode
     * @memberof oracle_job.OracleJob
     * @static
    ...
    OracleJob.encode = function encode(message, writer) {
      ...
      if (message.tasks != null && message.tasks.length)
        for (let i = 0; i < message.tasks.length; ++i)
          $root.oracle_job.OracleJob.Task.encode(
            message.tasks[i],
    ...
    /**
     * Encodes the specified OracleJob message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.verify|verify} messages.
    ...
    OracleJob.decode = function decode(reader, length) {
      ...
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.oracle_job.OracleJob();
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          case 1: {
            ...
            message.tasks.push(
              $root.oracle_job.OracleJob.Task.decode(reader, reader.uint32())
            );
            break;
          }
          default:
    ...
    OracleJob.fromObject = function fromObject(object) {
      if (object instanceof $root.oracle_job.OracleJob) return object;
      ...
      if (object.tasks) {
        ...
        for (let i = 0; i < object.tasks.length; ++i) {
          ...
          message.tasks[i] = $root.oracle_job.OracleJob.Task.fromObject(
            object.tasks[i]
          );
        }
      }
    ...
    OracleJob.toObject = function toObject(message, options) {
      ...
      if (message.tasks && message.tasks.length) {
        ...
        for (let j = 0; j < message.tasks.length; ++j)
          object.tasks[j] = $root.oracle_job.OracleJob.Task.toObject(
            message.tasks[j],
            options
          );
      }
    ...
    OracleJob.HttpTask = (function () {
      ...
      /**
       * Encodes the specified HttpTask message. Does not implicitly {@apilink oracle_job.OracleJob.HttpTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.HttpTask
       * @static
      ...
      HttpTask.encode = function encode(message, writer) {
        ...
        if (message.headers != null && message.headers.length)
          for (let i = 0; i < message.headers.length; ++i)
            $root.oracle_job.OracleJob.HttpTask.Header.encode(
              message.headers[i],
      ...
      /**
       * Encodes the specified HttpTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.HttpTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.HttpTask
       * @static
       * @param {oracle_job.OracleJob.IHttpTask} message HttpTask message or plain object to encode
      ...
      HttpTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.HttpTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
            ...
            case 3: {
              ...
              message.headers.push(
                $root.oracle_job.OracleJob.HttpTask.Header.decode(
                  reader,
                  reader.uint32()
                )
              );
      ...
      HttpTask.verify = function verify(message) {
        ...
        if (message.headers != null && message.hasOwnProperty("headers")) {
          ...
          for (let i = 0; i < message.headers.length; ++i) {
            let error = $root.oracle_job.OracleJob.HttpTask.Header.verify(
              message.headers[i]
            );
      ...
      HttpTask.fromObject = function fromObject(object) {
        ...
        if (object.headers) {
          if (!Array.isArray(object.headers))
            throw TypeError(
              ".oracle_job.OracleJob.HttpTask.headers: array expected"
            );
          message.headers = [];
          for (let i = 0; i < object.headers.length; ++i) {
            if (typeof object.headers[i] !== "object")
              throw TypeError(
                ".oracle_job.OracleJob.HttpTask.headers: object expected"
              );
            message.headers[i] =
              $root.oracle_job.OracleJob.HttpTask.Header.fromObject(
                object.headers[i]
              );
          }
        }
      ...
      HttpTask.toObject = function toObject(message, options) {
        ...
        if (message.method != null && message.hasOwnProperty("method"))
          object.method =
            options.enums === String
              ? $root.oracle_job.OracleJob.HttpTask.Method[message.method] ===
                undefined
                ? message.method
                : $root.oracle_job.OracleJob.HttpTask.Method[message.method]
              : message.method;
        if (message.headers && message.headers.length) {
          ...
          for (let j = 0; j < message.headers.length; ++j)
            object.headers[j] =
              $root.oracle_job.OracleJob.HttpTask.Header.toObject(
                message.headers[j],
                options
              );
        }
      ...
      HttpTask.Header = (function () {
        ...
        /**
         * Encodes the specified Header message. Does not implicitly {@apilink oracle_job.OracleJob.HttpTask.Header.verify|verify} messages.
         * @function encode
         * @memberof oracle_job.OracleJob.HttpTask.Header
         * @static
        ...
        /**
         * Encodes the specified Header message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.HttpTask.Header.verify|verify} messages.
         * @function encodeDelimited
         * @memberof oracle_job.OracleJob.HttpTask.Header
         * @static
         * @param {oracle_job.OracleJob.HttpTask.IHeader} message Header message or plain object to encode
        ...
        Header.decode = function decode(reader, length) {
          if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
          let end = length === undefined ? reader.len : reader.pos + length,
            message = new $root.oracle_job.OracleJob.HttpTask.Header();
          while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
              case 1: {
    ...
    OracleJob.JsonParseTask = (function () {
      ...
      /**
       * Encodes the specified JsonParseTask message. Does not implicitly {@apilink oracle_job.OracleJob.JsonParseTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.JsonParseTask
       * @static
      ...
      /**
       * Encodes the specified JsonParseTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.JsonParseTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.JsonParseTask
       * @static
       * @param {oracle_job.OracleJob.IJsonParseTask} message JsonParseTask message or plain object to encode
      ...
      JsonParseTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.JsonParseTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
      ...
      JsonParseTask.toObject = function toObject(message, options) {
        ...
        if (
          ...
          object.aggregationMethod =
            options.enums === String
              ? $root.oracle_job.OracleJob.JsonParseTask.AggregationMethod[
    ...
    OracleJob.MedianTask = (function () {
      ...
      /**
       * Encodes the specified MedianTask message. Does not implicitly {@apilink oracle_job.OracleJob.MedianTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.MedianTask
       * @static
      ...
      MedianTask.encode = function encode(message, writer) {
        ...
        if (message.jobs != null && message.jobs.length)
          for (let i = 0; i < message.jobs.length; ++i)
            $root.oracle_job.OracleJob.encode(
              message.jobs[i],
        ...
        if (
          message.maxRangePercent != null &&
          Object.hasOwnProperty.call(message, "maxRangePercent")
        )
          writer
            .uint32(/* id 4, wireType 2 =*/ 34)
            .string(message.maxRangePercent);
        return writer;
      };

      /**
       * Encodes the specified MedianTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.MedianTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.MedianTask
       * @static
       * @param {oracle_job.OracleJob.IMedianTask} message MedianTask message or plain object to encode
      ...
      MedianTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.MedianTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
            ...
            case 2: {
              ...
              message.jobs.push(
                $root.oracle_job.OracleJob.decode(reader, reader.uint32())
              );
              break;
            }
            case 3: {
      ...
      MedianTask.verify = function verify(message) {
        ...
        if (message.tasks != null && message.hasOwnProperty("tasks")) {
          if (!Array.isArray(message.tasks)) return "tasks: array expected";
          for (let i = 0; i < message.tasks.length; ++i) {
            let error = $root.oracle_job.OracleJob.Task.verify(
              message.tasks[i]
            );
            if (error) return "tasks." + error;
          }
        ...
        if (
          message.maxRangePercent != null &&
          message.hasOwnProperty("maxRangePercent")
        )
      ...
      MedianTask.fromObject = function fromObject(object) {
        ...
        if (object.tasks) {
          if (!Array.isArray(object.tasks))
            throw TypeError(
              ".oracle_job.OracleJob.MedianTask.tasks: array expected"
            );
          message.tasks = [];
          for (let i = 0; i < object.tasks.length; ++i) {
            if (typeof object.tasks[i] !== "object")
              throw TypeError(
                ".oracle_job.OracleJob.MedianTask.tasks: object expected"
              );
            message.tasks[i] = $root.oracle_job.OracleJob.Task.fromObject(
              object.tasks[i]
            );
        ...
        if (object.jobs) {
          if (!Array.isArray(object.jobs))
            throw TypeError(
              ".oracle_job.OracleJob.MedianTask.jobs: array expected"
            );
          message.jobs = [];
          for (let i = 0; i < object.jobs.length; ++i) {
            if (typeof object.jobs[i] !== "object")
              throw TypeError(
                ".oracle_job.OracleJob.MedianTask.jobs: object expected"
              );
            message.jobs[i] = $root.oracle_job.OracleJob.fromObject(
              object.jobs[i]
            );
          }
        }
      ...
      MedianTask.toObject = function toObject(message, options) {
        ...
        if (message.jobs && message.jobs.length) {
          ...
          for (let j = 0; j < message.jobs.length; ++j)
            object.jobs[j] = $root.oracle_job.OracleJob.toObject(
              message.jobs[j],
              options
            );
        }
    ...
    OracleJob.MeanTask = (function () {
      ...
      /**
       * Encodes the specified MeanTask message. Does not implicitly {@apilink oracle_job.OracleJob.MeanTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.MeanTask
       * @static
      ...
      /**
       * Encodes the specified MeanTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.MeanTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.MeanTask
       * @static
       * @param {oracle_job.OracleJob.IMeanTask} message MeanTask message or plain object to encode
      ...
      MeanTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.MeanTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
      ...
      MeanTask.fromObject = function fromObject(object) {
        ...
        if (object.tasks) {
          if (!Array.isArray(object.tasks))
            throw TypeError(
              ".oracle_job.OracleJob.MeanTask.tasks: array expected"
            );
          message.tasks = [];
          for (let i = 0; i < object.tasks.length; ++i) {
            if (typeof object.tasks[i] !== "object")
              throw TypeError(
                ".oracle_job.OracleJob.MeanTask.tasks: object expected"
              );
            message.tasks[i] = $root.oracle_job.OracleJob.Task.fromObject(
              object.tasks[i]
            );
        ...
        if (object.jobs) {
          if (!Array.isArray(object.jobs))
            throw TypeError(
              ".oracle_job.OracleJob.MeanTask.jobs: array expected"
            );
          message.jobs = [];
          for (let i = 0; i < object.jobs.length; ++i) {
            if (typeof object.jobs[i] !== "object")
              throw TypeError(
                ".oracle_job.OracleJob.MeanTask.jobs: object expected"
              );
            message.jobs[i] = $root.oracle_job.OracleJob.fromObject(
              object.jobs[i]
            );
    ...
    OracleJob.MaxTask = (function () {
      ...
      /**
       * Encodes the specified MaxTask message. Does not implicitly {@apilink oracle_job.OracleJob.MaxTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.MaxTask
       * @static
      ...
      /**
       * Encodes the specified MaxTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.MaxTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.MaxTask
       * @static
       * @param {oracle_job.OracleJob.IMaxTask} message MaxTask message or plain object to encode
      ...
      MaxTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.MaxTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
      ...
      MaxTask.fromObject = function fromObject(object) {
        if (object instanceof $root.oracle_job.OracleJob.MaxTask) return object;
        let message = new $root.oracle_job.OracleJob.MaxTask();
        if (object.tasks) {
          if (!Array.isArray(object.tasks))
            throw TypeError(
              ".oracle_job.OracleJob.MaxTask.tasks: array expected"
            );
          message.tasks = [];
          for (let i = 0; i < object.tasks.length; ++i) {
            if (typeof object.tasks[i] !== "object")
              throw TypeError(
                ".oracle_job.OracleJob.MaxTask.tasks: object expected"
              );
            message.tasks[i] = $root.oracle_job.OracleJob.Task.fromObject(
              object.tasks[i]
            );
        ...
        if (object.jobs) {
          if (!Array.isArray(object.jobs))
            throw TypeError(
              ".oracle_job.OracleJob.MaxTask.jobs: array expected"
            );
          message.jobs = [];
          for (let i = 0; i < object.jobs.length; ++i) {
            if (typeof object.jobs[i] !== "object")
              throw TypeError(
                ".oracle_job.OracleJob.MaxTask.jobs: object expected"
              );
            message.jobs[i] = $root.oracle_job.OracleJob.fromObject(
              object.jobs[i]
            );
    ...
    OracleJob.MinTask = (function () {
      ...
      /**
       * Encodes the specified MinTask message. Does not implicitly {@apilink oracle_job.OracleJob.MinTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.MinTask
       * @static
      ...
      /**
       * Encodes the specified MinTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.MinTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.MinTask
       * @static
       * @param {oracle_job.OracleJob.IMinTask} message MinTask message or plain object to encode
      ...
      MinTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.MinTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
      ...
      MinTask.fromObject = function fromObject(object) {
        if (object instanceof $root.oracle_job.OracleJob.MinTask) return object;
        let message = new $root.oracle_job.OracleJob.MinTask();
        if (object.tasks) {
          if (!Array.isArray(object.tasks))
            throw TypeError(
              ".oracle_job.OracleJob.MinTask.tasks: array expected"
            );
          message.tasks = [];
          for (let i = 0; i < object.tasks.length; ++i) {
            if (typeof object.tasks[i] !== "object")
              throw TypeError(
                ".oracle_job.OracleJob.MinTask.tasks: object expected"
              );
            message.tasks[i] = $root.oracle_job.OracleJob.Task.fromObject(
              object.tasks[i]
            );
        ...
        if (object.jobs) {
          if (!Array.isArray(object.jobs))
            throw TypeError(
              ".oracle_job.OracleJob.MinTask.jobs: array expected"
            );
          message.jobs = [];
          for (let i = 0; i < object.jobs.length; ++i) {
            if (typeof object.jobs[i] !== "object")
              throw TypeError(
                ".oracle_job.OracleJob.MinTask.jobs: object expected"
              );
            message.jobs[i] = $root.oracle_job.OracleJob.fromObject(
              object.jobs[i]
            );
    ...
    OracleJob.ValueTask = (function () {
      ...
      Object.defineProperty(ValueTask.prototype, "Value", {
        get: $util.oneOfGetter(
          ($oneOfFields = ["value", "aggregatorPubkey", "big", "hex", "utf8"])
        ),
      ...
      /**
       * Encodes the specified ValueTask message. Does not implicitly {@apilink oracle_job.OracleJob.ValueTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.ValueTask
       * @static
      ...
      /**
       * Encodes the specified ValueTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.ValueTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.ValueTask
       * @static
       * @param {oracle_job.OracleJob.IValueTask} message ValueTask message or plain object to encode
      ...
      ValueTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.ValueTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
      ...
      ValueTask.verify = function verify(message) {
        ...
        if (message.hex != null && message.hasOwnProperty("hex")) {
          if (properties.Value === 1) return "Value: multiple values";
          properties.Value = 1;
          if (!$util.isString(message.hex)) return "hex: string expected";
        }
        if (message.utf8 != null && message.hasOwnProperty("utf8")) {
          if (properties.Value === 1) return "Value: multiple values";
          properties.Value = 1;
          if (!$util.isString(message.utf8)) return "utf8: string expected";
        }
        return null;
      };
      ...
      ValueTask.fromObject = function fromObject(object) {
        ...
        if (object.hex != null) message.hex = String(object.hex);
        if (object.utf8 != null) message.utf8 = String(object.utf8);
        return message;
      };
      ...
      ValueTask.toObject = function toObject(message, options) {
        ...
        if (message.hex != null && message.hasOwnProperty("hex")) {
          ...
          if (options.oneofs) object.Value = "hex";
        }
        if (message.utf8 != null && message.hasOwnProperty("utf8")) {
          object.utf8 = message.utf8;
          if (options.oneofs) object.Value = "utf8";
        }
        return object;
      };
    ...
    OracleJob.WebsocketTask = (function () {
      ...
      /**
       * Encodes the specified WebsocketTask message. Does not implicitly {@apilink oracle_job.OracleJob.WebsocketTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.WebsocketTask
       * @static
      ...
      /**
       * Encodes the specified WebsocketTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.WebsocketTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.WebsocketTask
       * @static
       * @param {oracle_job.OracleJob.IWebsocketTask} message WebsocketTask message or plain object to encode
      ...
      WebsocketTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.WebsocketTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
    ...
    OracleJob.ConditionalTask = (function () {
      ...
      /**
       * Encodes the specified ConditionalTask message. Does not implicitly {@apilink oracle_job.OracleJob.ConditionalTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.ConditionalTask
       * @static
      ...
      /**
       * Encodes the specified ConditionalTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.ConditionalTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.ConditionalTask
       * @static
       * @param {oracle_job.OracleJob.IConditionalTask} message ConditionalTask message or plain object to encode
      ...
      ConditionalTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.ConditionalTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
      ...
      ConditionalTask.fromObject = function fromObject(object) {
        ...
        if (object.attempt) {
          if (!Array.isArray(object.attempt))
            throw TypeError(
              ".oracle_job.OracleJob.ConditionalTask.attempt: array expected"
            );
          message.attempt = [];
          for (let i = 0; i < object.attempt.length; ++i) {
            if (typeof object.attempt[i] !== "object")
              throw TypeError(
                ".oracle_job.OracleJob.ConditionalTask.attempt: object expected"
              );
            message.attempt[i] = $root.oracle_job.OracleJob.Task.fromObject(
              object.attempt[i]
            );
          }
        }
        if (object.onFailure) {
          if (!Array.isArray(object.onFailure))
            throw TypeError(
              ".oracle_job.OracleJob.ConditionalTask.onFailure: array expected"
            );
          message.onFailure = [];
          for (let i = 0; i < object.onFailure.length; ++i) {
            if (typeof object.onFailure[i] !== "object")
              throw TypeError(
                ".oracle_job.OracleJob.ConditionalTask.onFailure: object expected"
              );
            message.onFailure[i] = $root.oracle_job.OracleJob.Task.fromObject(
              object.onFailure[i]
            );
          }
        }
      ...
      ConditionalTask.toObject = function toObject(message, options) {
        ...
        if (message.attempt && message.attempt.length) {
          ...
          for (let j = 0; j < message.attempt.length; ++j)
            object.attempt[j] = $root.oracle_job.OracleJob.Task.toObject(
              message.attempt[j],
              options
            );
        }
        if (message.onFailure && message.onFailure.length) {
          ...
          for (let j = 0; j < message.onFailure.length; ++j)
            object.onFailure[j] = $root.oracle_job.OracleJob.Task.toObject(
              message.onFailure[j],
              options
            );
        }
    ...
    OracleJob.DivideTask = (function () {
      ...
      /**
       * Encodes the specified DivideTask message. Does not implicitly {@apilink oracle_job.OracleJob.DivideTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.DivideTask
       * @static
      ...
      /**
       * Encodes the specified DivideTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.DivideTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.DivideTask
       * @static
       * @param {oracle_job.OracleJob.IDivideTask} message DivideTask message or plain object to encode
      ...
      DivideTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.DivideTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
            ...
            case 3: {
              message.job = $root.oracle_job.OracleJob.decode(
                reader,
                reader.uint32()
              );
              break;
      ...
      DivideTask.fromObject = function fromObject(object) {
        ...
        if (object.job != null) {
          if (typeof object.job !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.DivideTask.job: object expected"
            );
      ...
      DivideTask.toObject = function toObject(message, options) {
        ...
        if (message.job != null && message.hasOwnProperty("job")) {
          object.job = $root.oracle_job.OracleJob.toObject(
            message.job,
            options
          );
    ...
    OracleJob.MultiplyTask = (function () {
      ...
      /**
       * Encodes the specified MultiplyTask message. Does not implicitly {@apilink oracle_job.OracleJob.MultiplyTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.MultiplyTask
       * @static
      ...
      /**
       * Encodes the specified MultiplyTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.MultiplyTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.MultiplyTask
       * @static
       * @param {oracle_job.OracleJob.IMultiplyTask} message MultiplyTask message or plain object to encode
      ...
      MultiplyTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.MultiplyTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
      ...
      MultiplyTask.fromObject = function fromObject(object) {
        ...
        if (object.job != null) {
          if (typeof object.job !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.MultiplyTask.job: object expected"
            );
          message.job = $root.oracle_job.OracleJob.fromObject(object.job);
        }
        if (object.big != null) message.big = String(object.big);
    ...
    OracleJob.AddTask = (function () {
      ...
      /**
       * Encodes the specified AddTask message. Does not implicitly {@apilink oracle_job.OracleJob.AddTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.AddTask
       * @static
      ...
      /**
       * Encodes the specified AddTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.AddTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.AddTask
       * @static
       * @param {oracle_job.OracleJob.IAddTask} message AddTask message or plain object to encode
      ...
      AddTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.AddTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
      ...
      AddTask.fromObject = function fromObject(object) {
        if (object instanceof $root.oracle_job.OracleJob.AddTask) return object;
        ...
        if (object.job != null) {
          if (typeof object.job !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.AddTask.job: object expected"
            );
          message.job = $root.oracle_job.OracleJob.fromObject(object.job);
        }
        if (object.big != null) message.big = String(object.big);
    ...
    OracleJob.SubtractTask = (function () {
      ...
      /**
       * Encodes the specified SubtractTask message. Does not implicitly {@apilink oracle_job.OracleJob.SubtractTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.SubtractTask
       * @static
      ...
      /**
       * Encodes the specified SubtractTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.SubtractTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.SubtractTask
       * @static
       * @param {oracle_job.OracleJob.ISubtractTask} message SubtractTask message or plain object to encode
      ...
      SubtractTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.SubtractTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
      ...
      SubtractTask.fromObject = function fromObject(object) {
        ...
        if (object.job != null) {
          if (typeof object.job !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.SubtractTask.job: object expected"
            );
          message.job = $root.oracle_job.OracleJob.fromObject(object.job);
        }
        if (object.big != null) message.big = String(object.big);
    ...
    OracleJob.LpTokenPriceTask = (function () {
      ...
      /**
       * Encodes the specified LpTokenPriceTask message. Does not implicitly {@apilink oracle_job.OracleJob.LpTokenPriceTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.LpTokenPriceTask
       * @static
      ...
      /**
       * Encodes the specified LpTokenPriceTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.LpTokenPriceTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.LpTokenPriceTask
       * @static
       * @param {oracle_job.OracleJob.ILpTokenPriceTask} message LpTokenPriceTask message or plain object to encode
      ...
      LpTokenPriceTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.LpTokenPriceTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
      ...
      LpTokenPriceTask.verify = function verify(message) {
        ...
        if (
          ...
          for (let i = 0; i < message.priceFeedJobs.length; ++i) {
            let error = $root.oracle_job.OracleJob.verify(
              message.priceFeedJobs[i]
            );
      ...
      LpTokenPriceTask.fromObject = function fromObject(object) {
        ...
        if (object.priceFeedAddresses) {
          if (!Array.isArray(object.priceFeedAddresses))
            throw TypeError(
              ".oracle_job.OracleJob.LpTokenPriceTask.priceFeedAddresses: array expected"
            );
          message.priceFeedAddresses = [];
        ...
        if (object.priceFeedJobs) {
          if (!Array.isArray(object.priceFeedJobs))
            throw TypeError(
              ".oracle_job.OracleJob.LpTokenPriceTask.priceFeedJobs: array expected"
            );
          message.priceFeedJobs = [];
          for (let i = 0; i < object.priceFeedJobs.length; ++i) {
            if (typeof object.priceFeedJobs[i] !== "object")
              throw TypeError(
                ".oracle_job.OracleJob.LpTokenPriceTask.priceFeedJobs: object expected"
              );
            message.priceFeedJobs[i] = $root.oracle_job.OracleJob.fromObject(
      ...
      LpTokenPriceTask.toObject = function toObject(message, options) {
        ...
        if (message.priceFeedJobs && message.priceFeedJobs.length) {
          ...
          for (let j = 0; j < message.priceFeedJobs.length; ++j)
            object.priceFeedJobs[j] = $root.oracle_job.OracleJob.toObject(
    ...
    OracleJob.LpExchangeRateTask = (function () {
      ...
      /**
       * Encodes the specified LpExchangeRateTask message. Does not implicitly {@apilink oracle_job.OracleJob.LpExchangeRateTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.LpExchangeRateTask
       * @static
      ...
      /**
       * Encodes the specified LpExchangeRateTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.LpExchangeRateTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.LpExchangeRateTask
       * @static
       * @param {oracle_job.OracleJob.ILpExchangeRateTask} message LpExchangeRateTask message or plain object to encode
      ...
      LpExchangeRateTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.LpExchangeRateTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
    ...
    OracleJob.RegexExtractTask = (function () {
      ...
      /**
       * Encodes the specified RegexExtractTask message. Does not implicitly {@apilink oracle_job.OracleJob.RegexExtractTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.RegexExtractTask
       * @static
      ...
      /**
       * Encodes the specified RegexExtractTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.RegexExtractTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.RegexExtractTask
       * @static
       * @param {oracle_job.OracleJob.IRegexExtractTask} message RegexExtractTask message or plain object to encode
      ...
      RegexExtractTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.RegexExtractTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
    ...
    OracleJob.XStepPriceTask = (function () {
      ...
      /**
       * Encodes the specified XStepPriceTask message. Does not implicitly {@apilink oracle_job.OracleJob.XStepPriceTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.XStepPriceTask
       * @static
      ...
      XStepPriceTask.encode = function encode(message, writer) {
        ...
        if (
          ...
          $root.oracle_job.OracleJob.MedianTask.encode(
            message.stepJob,
            writer.uint32(/* id 1, wireType 2 =*/ 10).fork()
          ).ldelim();
        if (
      ...
      /**
       * Encodes the specified XStepPriceTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.XStepPriceTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.XStepPriceTask
       * @static
       * @param {oracle_job.OracleJob.IXStepPriceTask} message XStepPriceTask message or plain object to encode
      ...
      XStepPriceTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.XStepPriceTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
              message.stepJob = $root.oracle_job.OracleJob.MedianTask.decode(
                reader,
                reader.uint32()
              );
              break;
      ...
      XStepPriceTask.verify = function verify(message) {
        ...
        if (message.stepJob != null && message.hasOwnProperty("stepJob")) {
          ...
          {
            let error = $root.oracle_job.OracleJob.MedianTask.verify(
              message.stepJob
            );
      ...
      XStepPriceTask.fromObject = function fromObject(object) {
        ...
        if (object.stepJob != null) {
          if (typeof object.stepJob !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.XStepPriceTask.stepJob: object expected"
            );
          message.stepJob = $root.oracle_job.OracleJob.MedianTask.fromObject(
            object.stepJob
          );
        }
      ...
      XStepPriceTask.toObject = function toObject(message, options) {
        ...
        let object = {};
        if (message.stepJob != null && message.hasOwnProperty("stepJob")) {
          object.stepJob = $root.oracle_job.OracleJob.MedianTask.toObject(
            message.stepJob,
            options
          );
    ...
    OracleJob.TwapTask = (function () {
      ...
      /**
       * Encodes the specified TwapTask message. Does not implicitly {@apilink oracle_job.OracleJob.TwapTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.TwapTask
       * @static
      ...
      TwapTask.encode = function encode(message, writer) {
        ...
        if (
          ...
          $root.oracle_job.OracleJob.CronParseTask.encode(
      ...
      /**
       * Encodes the specified TwapTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.TwapTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.TwapTask
       * @static
       * @param {oracle_job.OracleJob.ITwapTask} message TwapTask message or plain object to encode
      ...
      TwapTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.TwapTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
            ...
            case 6: {
              message.endingUnixTimestampTask =
                $root.oracle_job.OracleJob.CronParseTask.decode(
                  reader,
                  reader.uint32()
                );
              break;
      ...
      TwapTask.verify = function verify(message) {
        ...
        if (
          ...
          let error = $root.oracle_job.OracleJob.CronParseTask.verify(
            message.endingUnixTimestampTask
          );
      ...
      TwapTask.fromObject = function fromObject(object) {
        ...
        if (object.endingUnixTimestampTask != null) {
          if (typeof object.endingUnixTimestampTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.TwapTask.endingUnixTimestampTask: object expected"
            );
          message.endingUnixTimestampTask =
            $root.oracle_job.OracleJob.CronParseTask.fromObject(
      ...
      TwapTask.toObject = function toObject(message, options) {
        ...
        if (
          ...
          object.endingUnixTimestampTask =
            $root.oracle_job.OracleJob.CronParseTask.toObject(
              message.endingUnixTimestampTask,
              options
            );
        return object;
    ...
    OracleJob.SerumSwapTask = (function () {
      ...
      /**
       * Encodes the specified SerumSwapTask message. Does not implicitly {@apilink oracle_job.OracleJob.SerumSwapTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.SerumSwapTask
       * @static
      ...
      /**
       * Encodes the specified SerumSwapTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.SerumSwapTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.SerumSwapTask
       * @static
       * @param {oracle_job.OracleJob.ISerumSwapTask} message SerumSwapTask message or plain object to encode
      ...
      SerumSwapTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.SerumSwapTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
    ...
    OracleJob.PowTask = (function () {
      ...
      /**
       * Encodes the specified PowTask message. Does not implicitly {@apilink oracle_job.OracleJob.PowTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.PowTask
       * @static
      ...
      /**
       * Encodes the specified PowTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.PowTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.PowTask
       * @static
       * @param {oracle_job.OracleJob.IPowTask} message PowTask message or plain object to encode
      ...
      PowTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.PowTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
      ...
      PowTask.fromObject = function fromObject(object) {
        if (object instanceof $root.oracle_job.OracleJob.PowTask) return object;
    ...
    OracleJob.LendingRateTask = (function () {
      ...
      /**
       * Encodes the specified LendingRateTask message. Does not implicitly {@apilink oracle_job.OracleJob.LendingRateTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.LendingRateTask
       * @static
      ...
      /**
       * Encodes the specified LendingRateTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.LendingRateTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.LendingRateTask
       * @static
       * @param {oracle_job.OracleJob.ILendingRateTask} message LendingRateTask message or plain object to encode
      ...
      LendingRateTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.LendingRateTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
      ...
      LendingRateTask.toObject = function toObject(message, options) {
        ...
        if (message.field != null && message.hasOwnProperty("field"))
          object.field =
            options.enums === String
              ? $root.oracle_job.OracleJob.LendingRateTask.Field[
                  message.field
                ] === undefined
                ? message.field
                : $root.oracle_job.OracleJob.LendingRateTask.Field[
    ...
    OracleJob.MangoPerpMarketTask = (function () {
      ...
      /**
       * Encodes the specified MangoPerpMarketTask message. Does not implicitly {@apilink oracle_job.OracleJob.MangoPerpMarketTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.MangoPerpMarketTask
       * @static
      ...
      /**
       * Encodes the specified MangoPerpMarketTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.MangoPerpMarketTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.MangoPerpMarketTask
       * @static
       * @param {oracle_job.OracleJob.IMangoPerpMarketTask} message MangoPerpMarketTask message or plain object to encode
      ...
      MangoPerpMarketTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.MangoPerpMarketTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
    ...
    OracleJob.JupiterSwapTask = (function () {
      ...
      /**
       * Encodes the specified JupiterSwapTask message. Does not implicitly {@apilink oracle_job.OracleJob.JupiterSwapTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.JupiterSwapTask
       * @static
      ...
      JupiterSwapTask.encode = function encode(message, writer) {
        ...
        if (
          ...
          $root.oracle_job.OracleJob.JupiterSwapTask.FilterList.encode(
            message.allowList,
      ...
      /**
       * Encodes the specified JupiterSwapTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.JupiterSwapTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.JupiterSwapTask
       * @static
       * @param {oracle_job.OracleJob.IJupiterSwapTask} message JupiterSwapTask message or plain object to encode
      ...
      JupiterSwapTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.JupiterSwapTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
            ...
            case 4: {
              message.allowList =
                $root.oracle_job.OracleJob.JupiterSwapTask.FilterList.decode(
                  reader,
                  reader.uint32()
                );
              break;
      ...
      JupiterSwapTask.verify = function verify(message) {
        ...
        if (message.allowList != null && message.hasOwnProperty("allowList")) {
          ...
          {
            let error =
              $root.oracle_job.OracleJob.JupiterSwapTask.FilterList.verify(
                message.allowList
              );
      ...
      JupiterSwapTask.fromObject = function fromObject(object) {
        ...
        if (object.allowList != null) {
          if (typeof object.allowList !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.JupiterSwapTask.allowList: object expected"
            );
          message.allowList =
            $root.oracle_job.OracleJob.JupiterSwapTask.FilterList.fromObject(
              object.allowList
            );
        }
        if (object.denyList != null) {
          if (typeof object.denyList !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.JupiterSwapTask.denyList: object expected"
            );
          message.denyList =
            $root.oracle_job.OracleJob.JupiterSwapTask.FilterList.fromObject(
              object.denyList
      ...
      JupiterSwapTask.toObject = function toObject(message, options) {
        ...
        if (message.allowList != null && message.hasOwnProperty("allowList")) {
          object.allowList =
            $root.oracle_job.OracleJob.JupiterSwapTask.FilterList.toObject(
              message.allowList,
              options
            );
      ...
      JupiterSwapTask.FilterList = (function () {
        ...
        /**
         * Encodes the specified FilterList message. Does not implicitly {@apilink oracle_job.OracleJob.JupiterSwapTask.FilterList.verify|verify} messages.
         * @function encode
         * @memberof oracle_job.OracleJob.JupiterSwapTask.FilterList
         * @static
        ...
        /**
         * Encodes the specified FilterList message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.JupiterSwapTask.FilterList.verify|verify} messages.
         * @function encodeDelimited
         * @memberof oracle_job.OracleJob.JupiterSwapTask.FilterList
         * @static
         * @param {oracle_job.OracleJob.JupiterSwapTask.IFilterList} message FilterList message or plain object to encode
        ...
        FilterList.decode = function decode(reader, length) {
          ...
          let end = length === undefined ? reader.len : reader.pos + length,
            message =
              new $root.oracle_job.OracleJob.JupiterSwapTask.FilterList();
          while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
              case 1: {
        ...
        FilterList.fromObject = function fromObject(object) {
          if (
            object instanceof
            $root.oracle_job.OracleJob.JupiterSwapTask.FilterList
          )
            return object;
          let message =
            new $root.oracle_job.OracleJob.JupiterSwapTask.FilterList();
          if (object.labels) {
            if (!Array.isArray(object.labels))
              throw TypeError(
                ".oracle_job.OracleJob.JupiterSwapTask.FilterList.labels: array expected"
              );
            message.labels = [];
        ...
        FilterList.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
          ...
          return (
            typeUrlPrefix + "/oracle_job.OracleJob.JupiterSwapTask.FilterList"
          );
        };
    ...
    OracleJob.PerpMarketTask = (function () {
      ...
      /**
       * Encodes the specified PerpMarketTask message. Does not implicitly {@apilink oracle_job.OracleJob.PerpMarketTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.PerpMarketTask
       * @static
      ...
      /**
       * Encodes the specified PerpMarketTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.PerpMarketTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.PerpMarketTask
       * @static
       * @param {oracle_job.OracleJob.IPerpMarketTask} message PerpMarketTask message or plain object to encode
      ...
      PerpMarketTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.PerpMarketTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
    ...
    OracleJob.OracleTask = (function () {
      ...
      /**
       * Encodes the specified OracleTask message. Does not implicitly {@apilink oracle_job.OracleJob.OracleTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.OracleTask
       * @static
      ...
      /**
       * Encodes the specified OracleTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.OracleTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.OracleTask
       * @static
       * @param {oracle_job.OracleJob.IOracleTask} message OracleTask message or plain object to encode
      ...
      OracleTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.OracleTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
    ...
    OracleJob.AnchorFetchTask = (function () {
      ...
      /**
       * Encodes the specified AnchorFetchTask message. Does not implicitly {@apilink oracle_job.OracleJob.AnchorFetchTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.AnchorFetchTask
       * @static
      ...
      /**
       * Encodes the specified AnchorFetchTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.AnchorFetchTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.AnchorFetchTask
       * @static
       * @param {oracle_job.OracleJob.IAnchorFetchTask} message AnchorFetchTask message or plain object to encode
      ...
      AnchorFetchTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.AnchorFetchTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
    ...
    OracleJob.SplStakePoolTask = (function () {
      ...
      /**
       * Encodes the specified SplStakePoolTask message. Does not implicitly {@apilink oracle_job.OracleJob.SplStakePoolTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.SplStakePoolTask
       * @static
      ...
      /**
       * Encodes the specified SplStakePoolTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.SplStakePoolTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.SplStakePoolTask
       * @static
       * @param {oracle_job.OracleJob.ISplStakePoolTask} message SplStakePoolTask message or plain object to encode
      ...
      SplStakePoolTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.SplStakePoolTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
    ...
    OracleJob.SplTokenParseTask = (function () {
      ...
      /**
       * Encodes the specified SplTokenParseTask message. Does not implicitly {@apilink oracle_job.OracleJob.SplTokenParseTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.SplTokenParseTask
       * @static
      ...
      /**
       * Encodes the specified SplTokenParseTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.SplTokenParseTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.SplTokenParseTask
       * @static
       * @param {oracle_job.OracleJob.ISplTokenParseTask} message SplTokenParseTask message or plain object to encode
      ...
      SplTokenParseTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.SplTokenParseTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
    ...
    OracleJob.UniswapExchangeRateTask = (function () {
      ...
      /**
       * Encodes the specified UniswapExchangeRateTask message. Does not implicitly {@apilink oracle_job.OracleJob.UniswapExchangeRateTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.UniswapExchangeRateTask
       * @static
      ...
      UniswapExchangeRateTask.encode = function encode(message, writer) {
        ...
        if (
          message.routerAddress != null &&
          Object.hasOwnProperty.call(message, "routerAddress")
        )
          writer
            .uint32(/* id 7, wireType 2 =*/ 58)
            .string(message.routerAddress);
        if (
          message.factoryAddress != null &&
          Object.hasOwnProperty.call(message, "factoryAddress")
        )
          writer
            .uint32(/* id 8, wireType 2 =*/ 66)
            .string(message.factoryAddress);
        if (
          message.quoterAddress != null &&
          Object.hasOwnProperty.call(message, "quoterAddress")
        )
          writer
            .uint32(/* id 9, wireType 2 =*/ 74)
            .string(message.quoterAddress);
        return writer;
      };

      /**
       * Encodes the specified UniswapExchangeRateTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.UniswapExchangeRateTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.UniswapExchangeRateTask
       * @static
       * @param {oracle_job.OracleJob.IUniswapExchangeRateTask} message UniswapExchangeRateTask message or plain object to encode
      ...
      UniswapExchangeRateTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.UniswapExchangeRateTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
      ...
      UniswapExchangeRateTask.fromObject = function fromObject(object) {
        if (
          object instanceof $root.oracle_job.OracleJob.UniswapExchangeRateTask
        )
          return object;
      ...
      UniswapExchangeRateTask.toObject = function toObject(message, options) {
        ...
        if (options.defaults) {
          ...
          object.provider = "";
          object.version =
            options.enums === String ? "VERSION_V2_DEPRECATED" : 0;
        ...
        if (message.version != null && message.hasOwnProperty("version"))
          object.version =
            options.enums === String
              ? $root.oracle_job.OracleJob.UniswapExchangeRateTask.Version[
                  message.version
                ] === undefined
                ? message.version
                : $root.oracle_job.OracleJob.UniswapExchangeRateTask.Version[
    ...
    OracleJob.SushiswapExchangeRateTask = (function () {
      ...
      /**
       * Encodes the specified SushiswapExchangeRateTask message. Does not implicitly {@apilink oracle_job.OracleJob.SushiswapExchangeRateTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.SushiswapExchangeRateTask
       * @static
      ...
      /**
       * Encodes the specified SushiswapExchangeRateTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.SushiswapExchangeRateTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.SushiswapExchangeRateTask
       * @static
       * @param {oracle_job.OracleJob.ISushiswapExchangeRateTask} message SushiswapExchangeRateTask message or plain object to encode
      ...
      SushiswapExchangeRateTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.SushiswapExchangeRateTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
      ...
      SushiswapExchangeRateTask.fromObject = function fromObject(object) {
        if (
          object instanceof $root.oracle_job.OracleJob.SushiswapExchangeRateTask
        )
          return object;
        let message =
          new $root.oracle_job.OracleJob.SushiswapExchangeRateTask();
        if (object.inTokenAddress != null)
          message.inTokenAddress = String(object.inTokenAddress);
        if (object.outTokenAddress != null)
          message.outTokenAddress = String(object.outTokenAddress);
      ...
      SushiswapExchangeRateTask.getTypeUrl = function getTypeUrl(
        ...
        return (
          typeUrlPrefix + "/oracle_job.OracleJob.SushiswapExchangeRateTask"
        );
      };
    ...
    OracleJob.PancakeswapExchangeRateTask = (function () {
      ...
      /**
       * Encodes the specified PancakeswapExchangeRateTask message. Does not implicitly {@apilink oracle_job.OracleJob.PancakeswapExchangeRateTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.PancakeswapExchangeRateTask
       * @static
      ...
      /**
       * Encodes the specified PancakeswapExchangeRateTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.PancakeswapExchangeRateTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.PancakeswapExchangeRateTask
       * @static
       * @param {oracle_job.OracleJob.IPancakeswapExchangeRateTask} message PancakeswapExchangeRateTask message or plain object to encode
      ...
      PancakeswapExchangeRateTask.decode = function decode(reader, length) {
        ...
        let end = length === undefined ? reader.len : reader.pos + length,
          message =
            new $root.oracle_job.OracleJob.PancakeswapExchangeRateTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
      ...
      PancakeswapExchangeRateTask.fromObject = function fromObject(object) {
        if (
          object instanceof
          $root.oracle_job.OracleJob.PancakeswapExchangeRateTask
        )
          return object;
        let message =
          new $root.oracle_job.OracleJob.PancakeswapExchangeRateTask();
      ...
      PancakeswapExchangeRateTask.getTypeUrl = function getTypeUrl(
        ...
        return (
          typeUrlPrefix + "/oracle_job.OracleJob.PancakeswapExchangeRateTask"
        );
      };
    ...
    OracleJob.CacheTask = (function () {
      ...
      /**
       * Encodes the specified CacheTask message. Does not implicitly {@apilink oracle_job.OracleJob.CacheTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.CacheTask
       * @static
      ...
      CacheTask.encode = function encode(message, writer) {
        ...
        if (message.cacheItems != null && message.cacheItems.length)
          for (let i = 0; i < message.cacheItems.length; ++i)
            $root.oracle_job.OracleJob.CacheTask.CacheItem.encode(
      ...
      /**
       * Encodes the specified CacheTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.CacheTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.CacheTask
       * @static
       * @param {oracle_job.OracleJob.ICacheTask} message CacheTask message or plain object to encode
      ...
      CacheTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.CacheTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
              ...
              message.cacheItems.push(
                $root.oracle_job.OracleJob.CacheTask.CacheItem.decode(
                  reader,
                  reader.uint32()
                )
              );
      ...
      CacheTask.verify = function verify(message) {
        ...
        if (
          ...
          for (let i = 0; i < message.cacheItems.length; ++i) {
            let error = $root.oracle_job.OracleJob.CacheTask.CacheItem.verify(
              message.cacheItems[i]
            );
      ...
      CacheTask.fromObject = function fromObject(object) {
        ...
        if (object.cacheItems) {
          if (!Array.isArray(object.cacheItems))
            throw TypeError(
              ".oracle_job.OracleJob.CacheTask.cacheItems: array expected"
            );
          message.cacheItems = [];
          for (let i = 0; i < object.cacheItems.length; ++i) {
            if (typeof object.cacheItems[i] !== "object")
              throw TypeError(
                ".oracle_job.OracleJob.CacheTask.cacheItems: object expected"
              );
            message.cacheItems[i] =
              $root.oracle_job.OracleJob.CacheTask.CacheItem.fromObject(
                object.cacheItems[i]
              );
          }
        }
      ...
      CacheTask.toObject = function toObject(message, options) {
        ...
        if (message.cacheItems && message.cacheItems.length) {
          ...
          for (let j = 0; j < message.cacheItems.length; ++j)
            object.cacheItems[j] =
              $root.oracle_job.OracleJob.CacheTask.CacheItem.toObject(
      ...
      CacheTask.CacheItem = (function () {
        ...
        /**
         * Encodes the specified CacheItem message. Does not implicitly {@apilink oracle_job.OracleJob.CacheTask.CacheItem.verify|verify} messages.
         * @function encode
         * @memberof oracle_job.OracleJob.CacheTask.CacheItem
         * @static
        ...
        /**
         * Encodes the specified CacheItem message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.CacheTask.CacheItem.verify|verify} messages.
         * @function encodeDelimited
         * @memberof oracle_job.OracleJob.CacheTask.CacheItem
         * @static
         * @param {oracle_job.OracleJob.CacheTask.ICacheItem} message CacheItem message or plain object to encode
        ...
        CacheItem.decode = function decode(reader, length) {
          if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
          let end = length === undefined ? reader.len : reader.pos + length,
            message = new $root.oracle_job.OracleJob.CacheTask.CacheItem();
          while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
              case 1: {
        ...
        CacheItem.fromObject = function fromObject(object) {
          ...
          if (object.job != null) {
            if (typeof object.job !== "object")
              throw TypeError(
                ".oracle_job.OracleJob.CacheTask.CacheItem.job: object expected"
              );
            message.job = $root.oracle_job.OracleJob.fromObject(object.job);
          }
          return message;
    ...
    OracleJob.SysclockOffsetTask = (function () {
      ...
      /**
       * Encodes the specified SysclockOffsetTask message. Does not implicitly {@apilink oracle_job.OracleJob.SysclockOffsetTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.SysclockOffsetTask
       * @static
      ...
      /**
       * Encodes the specified SysclockOffsetTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.SysclockOffsetTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.SysclockOffsetTask
       * @static
       * @param {oracle_job.OracleJob.ISysclockOffsetTask} message SysclockOffsetTask message or plain object to encode
      ...
      SysclockOffsetTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.SysclockOffsetTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            default:
    ...
    OracleJob.MarinadeStateTask = (function () {
      ...
      /**
       * Encodes the specified MarinadeStateTask message. Does not implicitly {@apilink oracle_job.OracleJob.MarinadeStateTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.MarinadeStateTask
       * @static
      ...
      /**
       * Encodes the specified MarinadeStateTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.MarinadeStateTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.MarinadeStateTask
       * @static
       * @param {oracle_job.OracleJob.IMarinadeStateTask} message MarinadeStateTask message or plain object to encode
      ...
      MarinadeStateTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.MarinadeStateTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            default:
    ...
    OracleJob.SolanaAccountDataFetchTask = (function () {
      ...
      /**
       * Encodes the specified SolanaAccountDataFetchTask message. Does not implicitly {@apilink oracle_job.OracleJob.SolanaAccountDataFetchTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.SolanaAccountDataFetchTask
       * @static
      ...
      SolanaAccountDataFetchTask.encode = function encode(message, writer) {
        ...
        if (
          ...
          Object.hasOwnProperty.call(message, "network")
        )
      ...
      /**
       * Encodes the specified SolanaAccountDataFetchTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.SolanaAccountDataFetchTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.SolanaAccountDataFetchTask
       * @static
       * @param {oracle_job.OracleJob.ISolanaAccountDataFetchTask} message SolanaAccountDataFetchTask message or plain object to encode
      ...
      SolanaAccountDataFetchTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.SolanaAccountDataFetchTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
      ...
      SolanaAccountDataFetchTask.fromObject = function fromObject(object) {
        if (
          object instanceof
          $root.oracle_job.OracleJob.SolanaAccountDataFetchTask
        )
          return object;
        let message =
          new $root.oracle_job.OracleJob.SolanaAccountDataFetchTask();
        if (object.pubkey != null) message.pubkey = String(object.pubkey);
      ...
      SolanaAccountDataFetchTask.toObject = function toObject(
        ...
        if (message.network != null && message.hasOwnProperty("network"))
          object.network =
            options.enums === String
              ? $root.oracle_job.OracleJob.SolanaAccountDataFetchTask.Network[
                  message.network
                ] === undefined
                ? message.network
                : $root.oracle_job.OracleJob.SolanaAccountDataFetchTask.Network[
      ...
      SolanaAccountDataFetchTask.getTypeUrl = function getTypeUrl(
        ...
        return (
          typeUrlPrefix + "/oracle_job.OracleJob.SolanaAccountDataFetchTask"
        );
      };
    ...
    OracleJob.CronParseTask = (function () {
      ...
      /**
       * Encodes the specified CronParseTask message. Does not implicitly {@apilink oracle_job.OracleJob.CronParseTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.CronParseTask
       * @static
      ...
      /**
       * Encodes the specified CronParseTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.CronParseTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.CronParseTask
       * @static
       * @param {oracle_job.OracleJob.ICronParseTask} message CronParseTask message or plain object to encode
      ...
      CronParseTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.CronParseTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
      ...
      CronParseTask.toObject = function toObject(message, options) {
        ...
        if (message.clock != null && message.hasOwnProperty("clock"))
          object.clock =
            options.enums === String
              ? $root.oracle_job.OracleJob.CronParseTask.ClockType[
                  message.clock
                ] === undefined
                ? message.clock
                : $root.oracle_job.OracleJob.CronParseTask.ClockType[
    ...
    OracleJob.BufferLayoutParseTask = (function () {
      ...
      /**
       * Encodes the specified BufferLayoutParseTask message. Does not implicitly {@apilink oracle_job.OracleJob.BufferLayoutParseTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.BufferLayoutParseTask
       * @static
      ...
      /**
       * Encodes the specified BufferLayoutParseTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.BufferLayoutParseTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.BufferLayoutParseTask
       * @static
       * @param {oracle_job.OracleJob.IBufferLayoutParseTask} message BufferLayoutParseTask message or plain object to encode
      ...
      BufferLayoutParseTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.BufferLayoutParseTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
      ...
      BufferLayoutParseTask.toObject = function toObject(message, options) {
        ...
        if (message.endian != null && message.hasOwnProperty("endian"))
          object.endian =
            options.enums === String
              ? $root.oracle_job.OracleJob.BufferLayoutParseTask.Endian[
                  message.endian
                ] === undefined
                ? message.endian
                : $root.oracle_job.OracleJob.BufferLayoutParseTask.Endian[
        ...
        if (message.type != null && message.hasOwnProperty("type"))
          object.type =
            options.enums === String
              ? $root.oracle_job.OracleJob.BufferLayoutParseTask
                  .BufferParseType[message.type] === undefined
                ? message.type
                : $root.oracle_job.OracleJob.BufferLayoutParseTask
                    .BufferParseType[message.type]
              : message.type;
        return object;
      };
    ...
    OracleJob.HistoryFunctionTask = (function () {
      ...
      /**
       * Encodes the specified HistoryFunctionTask message. Does not implicitly {@apilink oracle_job.OracleJob.HistoryFunctionTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.HistoryFunctionTask
       * @static
      ...
      /**
       * Encodes the specified HistoryFunctionTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.HistoryFunctionTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.HistoryFunctionTask
       * @static
       * @param {oracle_job.OracleJob.IHistoryFunctionTask} message HistoryFunctionTask message or plain object to encode
      ...
      HistoryFunctionTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.HistoryFunctionTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
      ...
      HistoryFunctionTask.toObject = function toObject(message, options) {
        ...
        if (message.method != null && message.hasOwnProperty("method"))
          object.method =
            options.enums === String
              ? $root.oracle_job.OracleJob.HistoryFunctionTask.Method[
                  message.method
                ] === undefined
                ? message.method
                : $root.oracle_job.OracleJob.HistoryFunctionTask.Method[
    ...
    OracleJob.VwapTask = (function () {
      ...
      /**
       * Encodes the specified VwapTask message. Does not implicitly {@apilink oracle_job.OracleJob.VwapTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.VwapTask
       * @static
      ...
      /**
       * Encodes the specified VwapTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.VwapTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.VwapTask
       * @static
       * @param {oracle_job.OracleJob.IVwapTask} message VwapTask message or plain object to encode
      ...
      VwapTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.VwapTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
    ...
    OracleJob.EwmaTask = (function () {
      ...
      /**
       * Encodes the specified EwmaTask message. Does not implicitly {@apilink oracle_job.OracleJob.EwmaTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.EwmaTask
       * @static
      ...
      /**
       * Encodes the specified EwmaTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.EwmaTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.EwmaTask
       * @static
       * @param {oracle_job.OracleJob.IEwmaTask} message EwmaTask message or plain object to encode
      ...
      EwmaTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.EwmaTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
    ...
    OracleJob.ComparisonTask = (function () {
      ...
      /**
       * Encodes the specified ComparisonTask message. Does not implicitly {@apilink oracle_job.OracleJob.ComparisonTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.ComparisonTask
       * @static
      ...
      /**
       * Encodes the specified ComparisonTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.ComparisonTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.ComparisonTask
       * @static
       * @param {oracle_job.OracleJob.IComparisonTask} message ComparisonTask message or plain object to encode
      ...
      ComparisonTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.ComparisonTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
            ...
            case 2: {
              message.lhs = $root.oracle_job.OracleJob.decode(
                reader,
                reader.uint32()
              );
              break;
            ...
            case 4: {
              message.rhs = $root.oracle_job.OracleJob.decode(
                reader,
                reader.uint32()
              );
              break;
            ...
            case 6: {
              message.onTrue = $root.oracle_job.OracleJob.decode(
                reader,
                reader.uint32()
              );
              break;
            ...
            case 8: {
              message.onFalse = $root.oracle_job.OracleJob.decode(
                reader,
                reader.uint32()
              );
              break;
            ...
            case 10: {
              message.onFailure = $root.oracle_job.OracleJob.decode(
                reader,
                reader.uint32()
              );
              break;
      ...
      ComparisonTask.fromObject = function fromObject(object) {
        ...
        if (object.lhs != null) {
          if (typeof object.lhs !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.ComparisonTask.lhs: object expected"
            );
        ...
        if (object.rhs != null) {
          if (typeof object.rhs !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.ComparisonTask.rhs: object expected"
            );
        ...
        if (object.onTrue != null) {
          if (typeof object.onTrue !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.ComparisonTask.onTrue: object expected"
            );
        ...
        if (object.onFalse != null) {
          if (typeof object.onFalse !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.ComparisonTask.onFalse: object expected"
            );
          message.onFalse = $root.oracle_job.OracleJob.fromObject(
            object.onFalse
          );
        }
        ...
        if (object.onFailure != null) {
          if (typeof object.onFailure !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.ComparisonTask.onFailure: object expected"
            );
          message.onFailure = $root.oracle_job.OracleJob.fromObject(
            object.onFailure
          );
        }
      ...
      ComparisonTask.toObject = function toObject(message, options) {
        ...
        if (message.op != null && message.hasOwnProperty("op"))
          object.op =
            options.enums === String
              ? $root.oracle_job.OracleJob.ComparisonTask.Operation[
                  message.op
                ] === undefined
                ? message.op
                : $root.oracle_job.OracleJob.ComparisonTask.Operation[
              ...
              : message.op;
        if (message.lhs != null && message.hasOwnProperty("lhs")) {
          object.lhs = $root.oracle_job.OracleJob.toObject(
            message.lhs,
            options
          );
        ...
        if (message.rhs != null && message.hasOwnProperty("rhs")) {
          object.rhs = $root.oracle_job.OracleJob.toObject(
            message.rhs,
            options
          );
        ...
        if (message.onTrue != null && message.hasOwnProperty("onTrue"))
          object.onTrue = $root.oracle_job.OracleJob.toObject(
            message.onTrue,
            options
          );
        if (
        ...
        if (message.onFalse != null && message.hasOwnProperty("onFalse"))
          object.onFalse = $root.oracle_job.OracleJob.toObject(
            message.onFalse,
            options
          );
        if (
        ...
        if (message.onFailure != null && message.hasOwnProperty("onFailure"))
          object.onFailure = $root.oracle_job.OracleJob.toObject(
            message.onFailure,
            options
          );
        if (
    ...
    OracleJob.RoundTask = (function () {
      ...
      /**
       * Encodes the specified RoundTask message. Does not implicitly {@apilink oracle_job.OracleJob.RoundTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.RoundTask
       * @static
      ...
      /**
       * Encodes the specified RoundTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.RoundTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.RoundTask
       * @static
       * @param {oracle_job.OracleJob.IRoundTask} message RoundTask message or plain object to encode
      ...
      RoundTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.RoundTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
      ...
      RoundTask.toObject = function toObject(message, options) {
        ...
        if (message.method != null && message.hasOwnProperty("method"))
          object.method =
            options.enums === String
              ? $root.oracle_job.OracleJob.RoundTask.Method[message.method] ===
                undefined
                ? message.method
                : $root.oracle_job.OracleJob.RoundTask.Method[message.method]
              : message.method;
    ...
    OracleJob.BoundTask = (function () {
      ...
      /**
       * Encodes the specified BoundTask message. Does not implicitly {@apilink oracle_job.OracleJob.BoundTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.BoundTask
       * @static
      ...
      /**
       * Encodes the specified BoundTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.BoundTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.BoundTask
       * @static
       * @param {oracle_job.OracleJob.IBoundTask} message BoundTask message or plain object to encode
      ...
      BoundTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.BoundTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
              message.lowerBound = $root.oracle_job.OracleJob.decode(
                reader,
                reader.uint32()
              );
              break;
            ...
            case 3: {
              message.upperBound = $root.oracle_job.OracleJob.decode(
                reader,
                reader.uint32()
              );
              break;
            ...
            case 5: {
              message.onExceedsUpperBound = $root.oracle_job.OracleJob.decode(
                reader,
                reader.uint32()
              );
              break;
            ...
            case 7: {
              message.onExceedsLowerBound = $root.oracle_job.OracleJob.decode(
                reader,
                reader.uint32()
              );
              break;
      ...
      BoundTask.fromObject = function fromObject(object) {
        ...
        if (object.lowerBound != null) {
          if (typeof object.lowerBound !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.BoundTask.lowerBound: object expected"
            );
          message.lowerBound = $root.oracle_job.OracleJob.fromObject(
            object.lowerBound
          );
        }
        ...
        if (object.upperBound != null) {
          if (typeof object.upperBound !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.BoundTask.upperBound: object expected"
            );
          message.upperBound = $root.oracle_job.OracleJob.fromObject(
            object.upperBound
          );
        }
        ...
        if (object.onExceedsUpperBound != null) {
          if (typeof object.onExceedsUpperBound !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.BoundTask.onExceedsUpperBound: object expected"
            );
          message.onExceedsUpperBound = $root.oracle_job.OracleJob.fromObject(
        ...
        if (object.onExceedsLowerBound != null) {
          if (typeof object.onExceedsLowerBound !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.BoundTask.onExceedsLowerBound: object expected"
            );
          message.onExceedsLowerBound = $root.oracle_job.OracleJob.fromObject(
      ...
      BoundTask.toObject = function toObject(message, options) {
        ...
        if (message.lowerBound != null && message.hasOwnProperty("lowerBound"))
          object.lowerBound = $root.oracle_job.OracleJob.toObject(
            message.lowerBound,
            options
          );
        if (
        ...
        if (message.upperBound != null && message.hasOwnProperty("upperBound"))
          object.upperBound = $root.oracle_job.OracleJob.toObject(
            message.upperBound,
            options
          );
        if (
        ...
        if (
          ...
          object.onExceedsUpperBound = $root.oracle_job.OracleJob.toObject(
            message.onExceedsUpperBound,
            options
          );
        if (
        ...
        if (
          ...
          object.onExceedsLowerBound = $root.oracle_job.OracleJob.toObject(
            message.onExceedsLowerBound,
            options
          );
        if (
    ...
    OracleJob.SecretsTask = (function () {
      ...
      SecretsTask.create = function create(properties) {
        return new SecretsTask(properties);
      };

      /**
       * Encodes the specified SecretsTask message. Does not implicitly {@apilink oracle_job.OracleJob.SecretsTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.SecretsTask
       * @static
      ...
      SecretsTask.encode = function encode(message, writer) {
        ...
        if (
          ...
          Object.hasOwnProperty.call(message, "authority")
        )
      ...
      /**
       * Encodes the specified SecretsTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.SecretsTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.SecretsTask
       * @static
       * @param {oracle_job.OracleJob.ISecretsTask} message SecretsTask message or plain object to encode
       ...
       * @throws {$protobuf.util.ProtocolError} If required fields are missing
       */
      SecretsTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.SecretsTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
    ...
    OracleJob.SanctumLstPriceTask = (function () {
      ...
      SanctumLstPriceTask.create = function create(properties) {
        return new SanctumLstPriceTask(properties);
      };

      /**
       * Encodes the specified SanctumLstPriceTask message. Does not implicitly {@apilink oracle_job.OracleJob.SanctumLstPriceTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.SanctumLstPriceTask
       * @static
      ...
      SanctumLstPriceTask.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (
          message.lstMint != null &&
          Object.hasOwnProperty.call(message, "lstMint")
        )
      ...
      /**
       * Encodes the specified SanctumLstPriceTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.SanctumLstPriceTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.SanctumLstPriceTask
       * @static
       * @param {oracle_job.OracleJob.ISanctumLstPriceTask} message SanctumLstPriceTask message or plain object to encode
       ...
       * @returns {$protobuf.Writer} Writer
       */
      SanctumLstPriceTask.encodeDelimited = function encodeDelimited(
        message,
        writer
      ) {
        return this.encode(message, writer).ldelim();
       ...
       * @throws {$protobuf.util.ProtocolError} If required fields are missing
       */
      SanctumLstPriceTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.SanctumLstPriceTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
      ...
      SanctumLstPriceTask.fromObject = function fromObject(object) {
        ...
        if (object.lstMint != null) message.lstMint = String(object.lstMint);
        return message;
      };
      ...
      SanctumLstPriceTask.toObject = function toObject(message, options) {
        if (!options) options = {};
        let object = {};
        if (options.defaults) object.lstMint = "";
        if (message.lstMint != null && message.hasOwnProperty("lstMint"))
    ...
    OracleJob.OndoUsdyTask = (function () {
      ...
      OndoUsdyTask.create = function create(properties) {
        return new OndoUsdyTask(properties);
      };

      /**
       * Encodes the specified OndoUsdyTask message. Does not implicitly {@apilink oracle_job.OracleJob.OndoUsdyTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.OndoUsdyTask
       * @static
      ...
      OndoUsdyTask.encode = function encode(message, writer) {
        ...
        if (
          ...
          Object.hasOwnProperty.call(message, "strategy")
        )
      ...
      /**
       * Encodes the specified OndoUsdyTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.OndoUsdyTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.OndoUsdyTask
       * @static
       * @param {oracle_job.OracleJob.IOndoUsdyTask} message OndoUsdyTask message or plain object to encode
       ...
       * @throws {$protobuf.util.ProtocolError} If required fields are missing
       */
      OndoUsdyTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.OndoUsdyTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
      ...
      OndoUsdyTask.toObject = function toObject(message, options) {
        ...
        if (options.defaults)
          object.strategy =
            options.enums === String ? "STRATEGY_FAIR_VALUE" : 0;
        if (message.strategy != null && message.hasOwnProperty("strategy"))
          object.strategy =
            options.enums === String
              ? $root.oracle_job.OracleJob.OndoUsdyTask.Strategy[
                  message.strategy
                ] === undefined
                ? message.strategy
                : $root.oracle_job.OracleJob.OndoUsdyTask.Strategy[
    ...
    OracleJob.MeteoraSwapTask = (function () {
      ...
      MeteoraSwapTask.create = function create(properties) {
        return new MeteoraSwapTask(properties);
      };

      /**
       * Encodes the specified MeteoraSwapTask message. Does not implicitly {@apilink oracle_job.OracleJob.MeteoraSwapTask.verify|verify} messages.
       * @function encode
       * @memberof oracle_job.OracleJob.MeteoraSwapTask
       * @static
      ...
      /**
       * Encodes the specified MeteoraSwapTask message, length delimited. Does not implicitly {@apilink oracle_job.OracleJob.MeteoraSwapTask.verify|verify} messages.
       * @function encodeDelimited
       * @memberof oracle_job.OracleJob.MeteoraSwapTask
       * @static
       * @param {oracle_job.OracleJob.IMeteoraSwapTask} message MeteoraSwapTask message or plain object to encode
       ...
       * @returns {$protobuf.Writer} Writer
       */
      MeteoraSwapTask.encodeDelimited = function encodeDelimited(
        message,
        writer
      ) {
        return this.encode(message, writer).ldelim();
       ...
       * @throws {$protobuf.util.ProtocolError} If required fields are missing
       */
      MeteoraSwapTask.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.MeteoraSwapTask();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
      ...
      MeteoraSwapTask.toObject = function toObject(message, options) {
        ...
        if (message.type != null && message.hasOwnProperty("type"))
          object.type =
            options.enums === String
              ? $root.oracle_job.OracleJob.MeteoraSwapTask.Type[
                  message.type
                ] === undefined
                ? message.type
                : $root.oracle_job.OracleJob.MeteoraSwapTask.Type[message.type]
              : message.type;
        return object;
      };
    ...
    OracleJob.Task = (function () {
       ...
       * @property {oracle_job.OracleJob.IWebsocketTask|null} [websocketTask] Task websocketTask
       ...
       * @property {oracle_job.OracleJob.ITwapTask|null} [twapTask] Task twapTask
       ...
       * @property {oracle_job.OracleJob.IMangoPerpMarketTask|null} [mangoPerpMarketTask] Task mangoPerpMarketTask
       ...
       * @property {oracle_job.OracleJob.IHistoryFunctionTask|null} [historyFunctionTask] Task historyFunctionTask
       * @property {oracle_job.OracleJob.IVwapTask|null} [vwapTask] Task vwapTask
       * @property {oracle_job.OracleJob.IEwmaTask|null} [ewmaTask] Task ewmaTask
      ...
      /**
       * Task websocketTask.
       * @member {oracle_job.OracleJob.IWebsocketTask|null|undefined} websocketTask
       * @memberof oracle_job.OracleJob.Task
       * @instance
       */
      ...
      /**
       * Task twapTask.
       * @member {oracle_job.OracleJob.ITwapTask|null|undefined} twapTask
       * @memberof oracle_job.OracleJob.Task
       * @instance
       */
       ...
       * @member {oracle_job.OracleJob.IMangoPerpMarketTask|null|undefined} mangoPerpMarketTask
       * @memberof oracle_job.OracleJob.Task
       * @instance
       */
       ...
       * @member {oracle_job.OracleJob.IHistoryFunctionTask|null|undefined} historyFunctionTask
       * @memberof oracle_job.OracleJob.Task
       * @instance
       */
      ...
      /**
       * Task vwapTask.
       * @member {oracle_job.OracleJob.IVwapTask|null|undefined} vwapTask
       * @memberof oracle_job.OracleJob.Task
       * @instance
       */
      ...
      /**
       * Task ewmaTask.
       * @member {oracle_job.OracleJob.IEwmaTask|null|undefined} ewmaTask
       * @memberof oracle_job.OracleJob.Task
       * @instance
       */
      ...
      Task.encode = function encode(message, writer) {
        ...
        if (
          ...
          $root.oracle_job.OracleJob.HttpTask.encode(
            message.httpTask,
            writer.uint32(/* id 1, wireType 2 =*/ 10).fork()
          ).ldelim();
        if (
          ...
          $root.oracle_job.OracleJob.JsonParseTask.encode(
        ...
        if (
          ...
          $root.oracle_job.OracleJob.MeanTask.encode(
            message.meanTask,
            writer.uint32(/* id 5, wireType 2 =*/ 42).fork()
          ).ldelim();
        if (
          ...
          $root.oracle_job.OracleJob.WebsocketTask.encode(
        ...
        if (
          ...
          $root.oracle_job.OracleJob.DivideTask.encode(
            message.divideTask,
            writer.uint32(/* id 7, wireType 2 =*/ 58).fork()
          ).ldelim();
        if (
          ...
          $root.oracle_job.OracleJob.MultiplyTask.encode(
        ...
        if (
          ...
          $root.oracle_job.OracleJob.LpTokenPriceTask.encode(
        ...
        if (
          ...
          $root.oracle_job.OracleJob.LpExchangeRateTask.encode(
        ...
        if (
          ...
          $root.oracle_job.OracleJob.ConditionalTask.encode(
        ...
        if (
          ...
          $root.oracle_job.OracleJob.ValueTask.encode(
            message.valueTask,
        ...
        if (
          ...
          $root.oracle_job.OracleJob.MaxTask.encode(
            message.maxTask,
        ...
        if (
          ...
          $root.oracle_job.OracleJob.RegexExtractTask.encode(
        ...
        if (
          ...
          $root.oracle_job.OracleJob.XStepPriceTask.encode(
        ...
        if (
          ...
          $root.oracle_job.OracleJob.AddTask.encode(
            message.addTask,
        ...
        if (
          ...
          $root.oracle_job.OracleJob.SubtractTask.encode(
        ...
        if (
          ...
          $root.oracle_job.OracleJob.TwapTask.encode(
            message.twapTask,
        ...
        if (
          ...
          $root.oracle_job.OracleJob.SerumSwapTask.encode(
        ...
        if (
          ...
          $root.oracle_job.OracleJob.PowTask.encode(
            message.powTask,
        ...
        if (
          ...
          $root.oracle_job.OracleJob.LendingRateTask.encode(
        ...
        if (
          ...
          $root.oracle_job.OracleJob.MangoPerpMarketTask.encode(
        ...
        if (
          ...
          $root.oracle_job.OracleJob.JupiterSwapTask.encode(
        ...
        if (
          ...
          $root.oracle_job.OracleJob.PerpMarketTask.encode(
        ...
        if (
          ...
          $root.oracle_job.OracleJob.OracleTask.encode(
            message.oracleTask,
        ...
        if (
          ...
          $root.oracle_job.OracleJob.AnchorFetchTask.encode(
        ...
        if (
          ...
          $root.oracle_job.OracleJob.SplStakePoolTask.encode(
        ...
        if (
          ...
          $root.oracle_job.OracleJob.SplTokenParseTask.encode(
        ...
        if (
          ...
          $root.oracle_job.OracleJob.UniswapExchangeRateTask.encode(
        ...
        if (
          ...
          $root.oracle_job.OracleJob.SushiswapExchangeRateTask.encode(
        ...
        if (
          ...
          $root.oracle_job.OracleJob.PancakeswapExchangeRateTask.encode(
        ...
        if (
          ...
          $root.oracle_job.OracleJob.CacheTask.encode(
            message.cacheTask,
        ...
        if (
          ...
          $root.oracle_job.OracleJob.SysclockOffsetTask.encode(
        ...
        if (
          ...
          $root.oracle_job.OracleJob.MarinadeStateTask.encode(
        ...
        if (
          ...
          $root.oracle_job.OracleJob.SolanaAccountDataFetchTask.encode(
        ...
        if (
          ...
          $root.oracle_job.OracleJob.BufferLayoutParseTask.encode(
        ...
        if (
          ...
          $root.oracle_job.OracleJob.MinTask.encode(
            message.minTask,
        ...
        if (
          ...
          $root.oracle_job.OracleJob.HistoryFunctionTask.encode(
        ...
        if (
          ...
          $root.oracle_job.OracleJob.VwapTask.encode(
            message.vwapTask,
        ...
        if (
          ...
          $root.oracle_job.OracleJob.EwmaTask.encode(
            message.ewmaTask,
        ...
        if (
          ...
          $root.oracle_job.OracleJob.ComparisonTask.encode(
        ...
        if (
          ...
          $root.oracle_job.OracleJob.RoundTask.encode(
            message.roundTask,
        ...
        if (
          ...
          $root.oracle_job.OracleJob.BoundTask.encode(
            message.boundTask,
            writer.uint32(/* id 46, wireType 2 =*/ 370).fork()
          ).ldelim();
        if (
          message.secretsTask != null &&
          Object.hasOwnProperty.call(message, "secretsTask")
        )
          $root.oracle_job.OracleJob.SecretsTask.encode(
            message.secretsTask,
            writer.uint32(/* id 47, wireType 2 =*/ 378).fork()
          ).ldelim();
        if (
          message.sanctumLstPriceTask != null &&
          Object.hasOwnProperty.call(message, "sanctumLstPriceTask")
        )
          $root.oracle_job.OracleJob.SanctumLstPriceTask.encode(
            message.sanctumLstPriceTask,
            writer.uint32(/* id 48, wireType 2 =*/ 386).fork()
          ).ldelim();
        if (
          message.ondoUsdyTask != null &&
          Object.hasOwnProperty.call(message, "ondoUsdyTask")
        )
          $root.oracle_job.OracleJob.OndoUsdyTask.encode(
            message.ondoUsdyTask,
            writer.uint32(/* id 49, wireType 2 =*/ 394).fork()
          ).ldelim();
        if (
          message.meteoraSwapTask != null &&
          Object.hasOwnProperty.call(message, "meteoraSwapTask")
        )
          $root.oracle_job.OracleJob.MeteoraSwapTask.encode(
      ...
      Task.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.oracle_job.OracleJob.Task();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
              message.httpTask = $root.oracle_job.OracleJob.HttpTask.decode(
                reader,
                reader.uint32()
              );
              break;
            ...
            case 2: {
              message.jsonParseTask =
                $root.oracle_job.OracleJob.JsonParseTask.decode(
                  reader,
                  reader.uint32()
                );
              break;
            ...
            case 4: {
              message.medianTask = $root.oracle_job.OracleJob.MedianTask.decode(
                reader,
                reader.uint32()
              );
              break;
            ...
            case 5: {
              message.meanTask = $root.oracle_job.OracleJob.MeanTask.decode(
                reader,
                reader.uint32()
              );
              break;
            ...
            case 6: {
              message.websocketTask =
                $root.oracle_job.OracleJob.WebsocketTask.decode(
                  reader,
                  reader.uint32()
                );
              break;
            ...
            case 7: {
              message.divideTask = $root.oracle_job.OracleJob.DivideTask.decode(
                reader,
                reader.uint32()
              );
              break;
            ...
            case 8: {
              message.multiplyTask =
                $root.oracle_job.OracleJob.MultiplyTask.decode(
                  reader,
                  reader.uint32()
                );
              break;
            ...
            case 9: {
              message.lpTokenPriceTask =
                $root.oracle_job.OracleJob.LpTokenPriceTask.decode(
                  reader,
                  reader.uint32()
                );
              break;
            ...
            case 10: {
              message.lpExchangeRateTask =
                $root.oracle_job.OracleJob.LpExchangeRateTask.decode(
                  reader,
                  reader.uint32()
                );
              break;
            ...
            case 11: {
              message.conditionalTask =
                $root.oracle_job.OracleJob.ConditionalTask.decode(
                  reader,
                  reader.uint32()
                );
              break;
            ...
            case 12: {
              message.valueTask = $root.oracle_job.OracleJob.ValueTask.decode(
                reader,
                reader.uint32()
              );
              break;
            ...
            case 13: {
              message.maxTask = $root.oracle_job.OracleJob.MaxTask.decode(
                reader,
                reader.uint32()
              );
              break;
            ...
            case 14: {
              message.regexExtractTask =
                $root.oracle_job.OracleJob.RegexExtractTask.decode(
                  reader,
                  reader.uint32()
                );
              break;
            ...
            case 15: {
              message.xstepPriceTask =
                $root.oracle_job.OracleJob.XStepPriceTask.decode(
                  reader,
                  reader.uint32()
                );
              break;
            ...
            case 16: {
              message.addTask = $root.oracle_job.OracleJob.AddTask.decode(
                reader,
                reader.uint32()
              );
              break;
            ...
            case 17: {
              message.subtractTask =
                $root.oracle_job.OracleJob.SubtractTask.decode(
                  reader,
                  reader.uint32()
                );
              break;
            ...
            case 18: {
              message.twapTask = $root.oracle_job.OracleJob.TwapTask.decode(
                reader,
                reader.uint32()
              );
              break;
            ...
            case 19: {
              message.serumSwapTask =
                $root.oracle_job.OracleJob.SerumSwapTask.decode(
                  reader,
                  reader.uint32()
                );
              break;
            ...
            case 20: {
              message.powTask = $root.oracle_job.OracleJob.PowTask.decode(
                reader,
                reader.uint32()
              );
              break;
            ...
            case 21: {
              message.lendingRateTask =
                $root.oracle_job.OracleJob.LendingRateTask.decode(
                  reader,
                  reader.uint32()
                );
              break;
            ...
            case 22: {
              message.mangoPerpMarketTask =
                $root.oracle_job.OracleJob.MangoPerpMarketTask.decode(
                  reader,
                  reader.uint32()
                );
              break;
            ...
            case 23: {
              message.jupiterSwapTask =
                $root.oracle_job.OracleJob.JupiterSwapTask.decode(
                  reader,
                  reader.uint32()
                );
              break;
            ...
            case 24: {
              message.perpMarketTask =
                $root.oracle_job.OracleJob.PerpMarketTask.decode(
                  reader,
                  reader.uint32()
                );
              break;
            ...
            case 25: {
              message.oracleTask = $root.oracle_job.OracleJob.OracleTask.decode(
                reader,
                reader.uint32()
              );
              break;
            ...
            case 26: {
              message.anchorFetchTask =
                $root.oracle_job.OracleJob.AnchorFetchTask.decode(
                  reader,
                  reader.uint32()
                );
              break;
            ...
            case 29: {
              message.splStakePoolTask =
                $root.oracle_job.OracleJob.SplStakePoolTask.decode(
                  reader,
                  reader.uint32()
                );
              break;
            ...
            case 30: {
              message.splTokenParseTask =
                $root.oracle_job.OracleJob.SplTokenParseTask.decode(
                  reader,
                  reader.uint32()
                );
              break;
            ...
            case 31: {
              message.uniswapExchangeRateTask =
                $root.oracle_job.OracleJob.UniswapExchangeRateTask.decode(
                  reader,
                  reader.uint32()
                );
              break;
            ...
            case 32: {
              message.sushiswapExchangeRateTask =
                $root.oracle_job.OracleJob.SushiswapExchangeRateTask.decode(
                  reader,
                  reader.uint32()
                );
              break;
            ...
            case 33: {
              message.pancakeswapExchangeRateTask =
                $root.oracle_job.OracleJob.PancakeswapExchangeRateTask.decode(
                  reader,
                  reader.uint32()
                );
              break;
            ...
            case 34: {
              message.cacheTask = $root.oracle_job.OracleJob.CacheTask.decode(
                reader,
                reader.uint32()
              );
              break;
            ...
            case 35: {
              message.sysclockOffsetTask =
                $root.oracle_job.OracleJob.SysclockOffsetTask.decode(
                  reader,
                  reader.uint32()
                );
              break;
            ...
            case 36: {
              message.marinadeStateTask =
                $root.oracle_job.OracleJob.MarinadeStateTask.decode(
                  reader,
                  reader.uint32()
                );
              break;
            ...
            case 37: {
              message.solanaAccountDataFetchTask =
                $root.oracle_job.OracleJob.SolanaAccountDataFetchTask.decode(
                  reader,
                  reader.uint32()
                );
              break;
            ...
            case 38: {
              message.bufferLayoutParseTask =
                $root.oracle_job.OracleJob.BufferLayoutParseTask.decode(
                  reader,
                  reader.uint32()
                );
              break;
            ...
            case 40: {
              message.minTask = $root.oracle_job.OracleJob.MinTask.decode(
                reader,
                reader.uint32()
              );
              break;
            ...
            case 41: {
              message.historyFunctionTask =
                $root.oracle_job.OracleJob.HistoryFunctionTask.decode(
                  reader,
                  reader.uint32()
                );
              break;
            ...
            case 42: {
              message.vwapTask = $root.oracle_job.OracleJob.VwapTask.decode(
                reader,
                reader.uint32()
              );
              break;
            ...
            case 43: {
              message.ewmaTask = $root.oracle_job.OracleJob.EwmaTask.decode(
                reader,
                reader.uint32()
              );
              break;
            ...
            case 44: {
              message.comparisonTask =
                $root.oracle_job.OracleJob.ComparisonTask.decode(
                  reader,
                  reader.uint32()
                );
              break;
            ...
            case 45: {
              message.roundTask = $root.oracle_job.OracleJob.RoundTask.decode(
                reader,
                reader.uint32()
              );
              break;
            ...
            case 46: {
              message.boundTask = $root.oracle_job.OracleJob.BoundTask.decode(
                reader,
                reader.uint32()
              );
              break;
            ...
            case 47: {
              message.secretsTask =
                $root.oracle_job.OracleJob.SecretsTask.decode(
                  reader,
                  reader.uint32()
                );
              break;
            ...
            case 48: {
              message.sanctumLstPriceTask =
                $root.oracle_job.OracleJob.SanctumLstPriceTask.decode(
                  reader,
                  reader.uint32()
                );
              break;
            ...
            case 49: {
              message.ondoUsdyTask =
                $root.oracle_job.OracleJob.OndoUsdyTask.decode(
                  reader,
                  reader.uint32()
                );
              break;
            ...
            case 50: {
              message.meteoraSwapTask =
                $root.oracle_job.OracleJob.MeteoraSwapTask.decode(
                  reader,
                  reader.uint32()
                );
              break;
      ...
      Task.verify = function verify(message) {
        ...
        if (message.httpTask != null && message.hasOwnProperty("httpTask")) {
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.HttpTask.verify(
              message.httpTask
            );
        ...
        if (
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.JsonParseTask.verify(
              message.jsonParseTask
            );
        ...
        if (message.meanTask != null && message.hasOwnProperty("meanTask")) {
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.MeanTask.verify(
              message.meanTask
            );
        ...
        if (
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.WebsocketTask.verify(
              message.websocketTask
            );
        ...
        if (
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.DivideTask.verify(
              message.divideTask
            );
        ...
        if (
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.MultiplyTask.verify(
              message.multiplyTask
            );
        ...
        if (
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.LpTokenPriceTask.verify(
              message.lpTokenPriceTask
            );
        ...
        if (
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.LpExchangeRateTask.verify(
              message.lpExchangeRateTask
            );
        ...
        if (
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.ConditionalTask.verify(
              message.conditionalTask
            );
        ...
        if (message.valueTask != null && message.hasOwnProperty("valueTask")) {
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.ValueTask.verify(
              message.valueTask
            );
        ...
        if (message.maxTask != null && message.hasOwnProperty("maxTask")) {
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.MaxTask.verify(
              message.maxTask
            );
        ...
        if (
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.RegexExtractTask.verify(
              message.regexExtractTask
            );
        ...
        if (
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.XStepPriceTask.verify(
              message.xstepPriceTask
            );
        ...
        if (message.addTask != null && message.hasOwnProperty("addTask")) {
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.AddTask.verify(
              message.addTask
            );
        ...
        if (
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.SubtractTask.verify(
              message.subtractTask
            );
        ...
        if (message.twapTask != null && message.hasOwnProperty("twapTask")) {
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.TwapTask.verify(
              message.twapTask
            );
        ...
        if (
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.SerumSwapTask.verify(
              message.serumSwapTask
            );
        ...
        if (message.powTask != null && message.hasOwnProperty("powTask")) {
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.PowTask.verify(
              message.powTask
            );
        ...
        if (
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.LendingRateTask.verify(
              message.lendingRateTask
            );
        ...
        if (
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.MangoPerpMarketTask.verify(
              message.mangoPerpMarketTask
            );
        ...
        if (
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.JupiterSwapTask.verify(
              message.jupiterSwapTask
            );
        ...
        if (
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.PerpMarketTask.verify(
              message.perpMarketTask
            );
        ...
        if (
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.OracleTask.verify(
              message.oracleTask
            );
        ...
        if (
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.AnchorFetchTask.verify(
              message.anchorFetchTask
            );
        ...
        if (
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.SplStakePoolTask.verify(
              message.splStakePoolTask
            );
        ...
        if (
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.SplTokenParseTask.verify(
              message.splTokenParseTask
            );
        ...
        if (
          ...
          {
            let error =
              $root.oracle_job.OracleJob.UniswapExchangeRateTask.verify(
                message.uniswapExchangeRateTask
              );
        ...
        if (
          ...
          {
            let error =
              $root.oracle_job.OracleJob.SushiswapExchangeRateTask.verify(
                message.sushiswapExchangeRateTask
              );
        ...
        if (
          ...
          {
            let error =
              $root.oracle_job.OracleJob.PancakeswapExchangeRateTask.verify(
                message.pancakeswapExchangeRateTask
              );
        ...
        if (message.cacheTask != null && message.hasOwnProperty("cacheTask")) {
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.CacheTask.verify(
              message.cacheTask
            );
        ...
        if (
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.SysclockOffsetTask.verify(
              message.sysclockOffsetTask
            );
        ...
        if (
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.MarinadeStateTask.verify(
              message.marinadeStateTask
            );
        ...
        if (
          ...
          {
            let error =
              $root.oracle_job.OracleJob.SolanaAccountDataFetchTask.verify(
                message.solanaAccountDataFetchTask
              );
        ...
        if (
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.BufferLayoutParseTask.verify(
              message.bufferLayoutParseTask
            );
        ...
        if (message.minTask != null && message.hasOwnProperty("minTask")) {
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.MinTask.verify(
              message.minTask
            );
        ...
        if (
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.HistoryFunctionTask.verify(
              message.historyFunctionTask
            );
        ...
        if (message.vwapTask != null && message.hasOwnProperty("vwapTask")) {
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.VwapTask.verify(
              message.vwapTask
            );
        ...
        if (message.ewmaTask != null && message.hasOwnProperty("ewmaTask")) {
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.EwmaTask.verify(
              message.ewmaTask
            );
        ...
        if (
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.ComparisonTask.verify(
              message.comparisonTask
            );
        ...
        if (message.roundTask != null && message.hasOwnProperty("roundTask")) {
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.RoundTask.verify(
              message.roundTask
            );
        ...
        if (message.boundTask != null && message.hasOwnProperty("boundTask")) {
          ...
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.BoundTask.verify(
              message.boundTask
            );
        ...
        if (
          message.secretsTask != null &&
          message.hasOwnProperty("secretsTask")
        ) {
          if (properties.Task === 1) return "Task: multiple values";
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.SecretsTask.verify(
              message.secretsTask
            );
            if (error) return "secretsTask." + error;
          }
        }
        if (
          message.sanctumLstPriceTask != null &&
          message.hasOwnProperty("sanctumLstPriceTask")
        ) {
          if (properties.Task === 1) return "Task: multiple values";
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.SanctumLstPriceTask.verify(
              message.sanctumLstPriceTask
            );
            if (error) return "sanctumLstPriceTask." + error;
          }
        }
        if (
          message.ondoUsdyTask != null &&
          message.hasOwnProperty("ondoUsdyTask")
        ) {
          if (properties.Task === 1) return "Task: multiple values";
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.OndoUsdyTask.verify(
              message.ondoUsdyTask
            );
            if (error) return "ondoUsdyTask." + error;
          }
        }
        if (
          message.meteoraSwapTask != null &&
          message.hasOwnProperty("meteoraSwapTask")
        ) {
          if (properties.Task === 1) return "Task: multiple values";
          properties.Task = 1;
          {
            let error = $root.oracle_job.OracleJob.MeteoraSwapTask.verify(
              message.meteoraSwapTask
            );
            if (error) return "meteoraSwapTask." + error;
          }
        }
        return null;
      };
      ...
      Task.fromObject = function fromObject(object) {
        if (object instanceof $root.oracle_job.OracleJob.Task) return object;
        let message = new $root.oracle_job.OracleJob.Task();
        if (object.httpTask != null) {
          if (typeof object.httpTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.httpTask: object expected"
            );
          message.httpTask = $root.oracle_job.OracleJob.HttpTask.fromObject(
            object.httpTask
          );
        }
        if (object.jsonParseTask != null) {
          if (typeof object.jsonParseTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.jsonParseTask: object expected"
            );
          message.jsonParseTask =
            $root.oracle_job.OracleJob.JsonParseTask.fromObject(
        ...
        if (object.medianTask != null) {
          if (typeof object.medianTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.medianTask: object expected"
            );
          message.medianTask = $root.oracle_job.OracleJob.MedianTask.fromObject(
            object.medianTask
          );
        }
        if (object.meanTask != null) {
          if (typeof object.meanTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.meanTask: object expected"
            );
          message.meanTask = $root.oracle_job.OracleJob.MeanTask.fromObject(
            object.meanTask
          );
        }
        if (object.websocketTask != null) {
          if (typeof object.websocketTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.websocketTask: object expected"
            );
          message.websocketTask =
            $root.oracle_job.OracleJob.WebsocketTask.fromObject(
        ...
        if (object.divideTask != null) {
          if (typeof object.divideTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.divideTask: object expected"
            );
          message.divideTask = $root.oracle_job.OracleJob.DivideTask.fromObject(
            object.divideTask
          );
        }
        if (object.multiplyTask != null) {
          if (typeof object.multiplyTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.multiplyTask: object expected"
            );
          message.multiplyTask =
            $root.oracle_job.OracleJob.MultiplyTask.fromObject(
              object.multiplyTask
            );
        }
        if (object.lpTokenPriceTask != null) {
          if (typeof object.lpTokenPriceTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.lpTokenPriceTask: object expected"
            );
          message.lpTokenPriceTask =
            $root.oracle_job.OracleJob.LpTokenPriceTask.fromObject(
        ...
        if (object.lpExchangeRateTask != null) {
          if (typeof object.lpExchangeRateTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.lpExchangeRateTask: object expected"
            );
          message.lpExchangeRateTask =
            $root.oracle_job.OracleJob.LpExchangeRateTask.fromObject(
        ...
        if (object.conditionalTask != null) {
          if (typeof object.conditionalTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.conditionalTask: object expected"
            );
          message.conditionalTask =
            $root.oracle_job.OracleJob.ConditionalTask.fromObject(
        ...
        if (object.valueTask != null) {
          if (typeof object.valueTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.valueTask: object expected"
            );
          message.valueTask = $root.oracle_job.OracleJob.ValueTask.fromObject(
            object.valueTask
          );
        }
        if (object.maxTask != null) {
          if (typeof object.maxTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.maxTask: object expected"
            );
          message.maxTask = $root.oracle_job.OracleJob.MaxTask.fromObject(
            object.maxTask
          );
        }
        if (object.regexExtractTask != null) {
          if (typeof object.regexExtractTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.regexExtractTask: object expected"
            );
          message.regexExtractTask =
            $root.oracle_job.OracleJob.RegexExtractTask.fromObject(
        ...
        if (object.xstepPriceTask != null) {
          if (typeof object.xstepPriceTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.xstepPriceTask: object expected"
            );
          message.xstepPriceTask =
            $root.oracle_job.OracleJob.XStepPriceTask.fromObject(
        ...
        if (object.addTask != null) {
          if (typeof object.addTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.addTask: object expected"
            );
          message.addTask = $root.oracle_job.OracleJob.AddTask.fromObject(
            object.addTask
          );
        }
        if (object.subtractTask != null) {
          if (typeof object.subtractTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.subtractTask: object expected"
            );
          message.subtractTask =
            $root.oracle_job.OracleJob.SubtractTask.fromObject(
              object.subtractTask
            );
        }
        if (object.twapTask != null) {
          if (typeof object.twapTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.twapTask: object expected"
            );
          message.twapTask = $root.oracle_job.OracleJob.TwapTask.fromObject(
            object.twapTask
          );
        }
        if (object.serumSwapTask != null) {
          if (typeof object.serumSwapTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.serumSwapTask: object expected"
            );
          message.serumSwapTask =
            $root.oracle_job.OracleJob.SerumSwapTask.fromObject(
        ...
        if (object.powTask != null) {
          if (typeof object.powTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.powTask: object expected"
            );
          message.powTask = $root.oracle_job.OracleJob.PowTask.fromObject(
            object.powTask
          );
        }
        if (object.lendingRateTask != null) {
          if (typeof object.lendingRateTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.lendingRateTask: object expected"
            );
          message.lendingRateTask =
            $root.oracle_job.OracleJob.LendingRateTask.fromObject(
        ...
        if (object.mangoPerpMarketTask != null) {
          if (typeof object.mangoPerpMarketTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.mangoPerpMarketTask: object expected"
            );
          message.mangoPerpMarketTask =
            $root.oracle_job.OracleJob.MangoPerpMarketTask.fromObject(
        ...
        if (object.jupiterSwapTask != null) {
          if (typeof object.jupiterSwapTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.jupiterSwapTask: object expected"
            );
          message.jupiterSwapTask =
            $root.oracle_job.OracleJob.JupiterSwapTask.fromObject(
        ...
        if (object.perpMarketTask != null) {
          if (typeof object.perpMarketTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.perpMarketTask: object expected"
            );
          message.perpMarketTask =
            $root.oracle_job.OracleJob.PerpMarketTask.fromObject(
        ...
        if (object.oracleTask != null) {
          if (typeof object.oracleTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.oracleTask: object expected"
            );
          message.oracleTask = $root.oracle_job.OracleJob.OracleTask.fromObject(
            object.oracleTask
          );
        }
        if (object.anchorFetchTask != null) {
          if (typeof object.anchorFetchTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.anchorFetchTask: object expected"
            );
          message.anchorFetchTask =
            $root.oracle_job.OracleJob.AnchorFetchTask.fromObject(
        ...
        if (object.splStakePoolTask != null) {
          if (typeof object.splStakePoolTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.splStakePoolTask: object expected"
            );
          message.splStakePoolTask =
            $root.oracle_job.OracleJob.SplStakePoolTask.fromObject(
        ...
        if (object.splTokenParseTask != null) {
          if (typeof object.splTokenParseTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.splTokenParseTask: object expected"
            );
          message.splTokenParseTask =
            $root.oracle_job.OracleJob.SplTokenParseTask.fromObject(
        ...
        if (object.uniswapExchangeRateTask != null) {
          if (typeof object.uniswapExchangeRateTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.uniswapExchangeRateTask: object expected"
            );
          message.uniswapExchangeRateTask =
            $root.oracle_job.OracleJob.UniswapExchangeRateTask.fromObject(
        ...
        if (object.sushiswapExchangeRateTask != null) {
          if (typeof object.sushiswapExchangeRateTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.sushiswapExchangeRateTask: object expected"
            );
          message.sushiswapExchangeRateTask =
            $root.oracle_job.OracleJob.SushiswapExchangeRateTask.fromObject(
        ...
        if (object.pancakeswapExchangeRateTask != null) {
          if (typeof object.pancakeswapExchangeRateTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.pancakeswapExchangeRateTask: object expected"
            );
          message.pancakeswapExchangeRateTask =
            $root.oracle_job.OracleJob.PancakeswapExchangeRateTask.fromObject(
        ...
        if (object.cacheTask != null) {
          if (typeof object.cacheTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.cacheTask: object expected"
            );
          message.cacheTask = $root.oracle_job.OracleJob.CacheTask.fromObject(
            object.cacheTask
          );
        }
        if (object.sysclockOffsetTask != null) {
          if (typeof object.sysclockOffsetTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.sysclockOffsetTask: object expected"
            );
          message.sysclockOffsetTask =
            $root.oracle_job.OracleJob.SysclockOffsetTask.fromObject(
        ...
        if (object.marinadeStateTask != null) {
          if (typeof object.marinadeStateTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.marinadeStateTask: object expected"
            );
          message.marinadeStateTask =
            $root.oracle_job.OracleJob.MarinadeStateTask.fromObject(
        ...
        if (object.solanaAccountDataFetchTask != null) {
          if (typeof object.solanaAccountDataFetchTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.solanaAccountDataFetchTask: object expected"
            );
          message.solanaAccountDataFetchTask =
            $root.oracle_job.OracleJob.SolanaAccountDataFetchTask.fromObject(
        ...
        if (object.bufferLayoutParseTask != null) {
          if (typeof object.bufferLayoutParseTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.bufferLayoutParseTask: object expected"
            );
          message.bufferLayoutParseTask =
            $root.oracle_job.OracleJob.BufferLayoutParseTask.fromObject(
        ...
        if (object.cronParseTask != null) {
          if (typeof object.cronParseTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.cronParseTask: object expected"
            );
          message.cronParseTask =
            $root.oracle_job.OracleJob.CronParseTask.fromObject(
        ...
        if (object.minTask != null) {
          if (typeof object.minTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.minTask: object expected"
            );
          message.minTask = $root.oracle_job.OracleJob.MinTask.fromObject(
            object.minTask
          );
        }
        if (object.historyFunctionTask != null) {
          if (typeof object.historyFunctionTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.historyFunctionTask: object expected"
            );
          message.historyFunctionTask =
            $root.oracle_job.OracleJob.HistoryFunctionTask.fromObject(
        ...
        if (object.vwapTask != null) {
          if (typeof object.vwapTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.vwapTask: object expected"
            );
          message.vwapTask = $root.oracle_job.OracleJob.VwapTask.fromObject(
            object.vwapTask
          );
        }
        if (object.ewmaTask != null) {
          if (typeof object.ewmaTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.ewmaTask: object expected"
            );
          message.ewmaTask = $root.oracle_job.OracleJob.EwmaTask.fromObject(
            object.ewmaTask
          );
        }
        if (object.comparisonTask != null) {
          if (typeof object.comparisonTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.comparisonTask: object expected"
            );
          message.comparisonTask =
            $root.oracle_job.OracleJob.ComparisonTask.fromObject(
        ...
        if (object.roundTask != null) {
          if (typeof object.roundTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.roundTask: object expected"
            );
          message.roundTask = $root.oracle_job.OracleJob.RoundTask.fromObject(
            object.roundTask
          );
        }
        if (object.boundTask != null) {
          if (typeof object.boundTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.boundTask: object expected"
            );
          message.boundTask = $root.oracle_job.OracleJob.BoundTask.fromObject(
            object.boundTask
          );
        }
        if (object.secretsTask != null) {
          if (typeof object.secretsTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.secretsTask: object expected"
            );
          message.secretsTask =
            $root.oracle_job.OracleJob.SecretsTask.fromObject(
              object.secretsTask
            );
        }
        if (object.sanctumLstPriceTask != null) {
          if (typeof object.sanctumLstPriceTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.sanctumLstPriceTask: object expected"
            );
          message.sanctumLstPriceTask =
            $root.oracle_job.OracleJob.SanctumLstPriceTask.fromObject(
              object.sanctumLstPriceTask
            );
        }
        if (object.ondoUsdyTask != null) {
          if (typeof object.ondoUsdyTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.ondoUsdyTask: object expected"
            );
          message.ondoUsdyTask =
            $root.oracle_job.OracleJob.OndoUsdyTask.fromObject(
              object.ondoUsdyTask
            );
        }
        if (object.meteoraSwapTask != null) {
          if (typeof object.meteoraSwapTask !== "object")
            throw TypeError(
              ".oracle_job.OracleJob.Task.meteoraSwapTask: object expected"
            );
          message.meteoraSwapTask =
            $root.oracle_job.OracleJob.MeteoraSwapTask.fromObject(
              object.meteoraSwapTask
            );
        }
        return message;
      };
      ...
      Task.toObject = function toObject(message, options) {
        ...
        let object = {};
        if (message.httpTask != null && message.hasOwnProperty("httpTask")) {
          object.httpTask = $root.oracle_job.OracleJob.HttpTask.toObject(
            message.httpTask,
            options
          );
        ...
        if (
          ...
          object.jsonParseTask =
            $root.oracle_job.OracleJob.JsonParseTask.toObject(
              message.jsonParseTask,
              options
            );
        ...
        if (
          ...
          object.medianTask = $root.oracle_job.OracleJob.MedianTask.toObject(
            message.medianTask,
            options
          );
        ...
        if (message.meanTask != null && message.hasOwnProperty("meanTask")) {
          object.meanTask = $root.oracle_job.OracleJob.MeanTask.toObject(
            message.meanTask,
            options
          );
        ...
        if (
          ...
          object.websocketTask =
            $root.oracle_job.OracleJob.WebsocketTask.toObject(
              message.websocketTask,
              options
            );
        ...
        if (
          ...
          object.divideTask = $root.oracle_job.OracleJob.DivideTask.toObject(
            message.divideTask,
            options
          );
        ...
        if (
          ...
          object.multiplyTask =
            $root.oracle_job.OracleJob.MultiplyTask.toObject(
              message.multiplyTask,
              options
            );
        ...
        if (
          ...
          object.lpTokenPriceTask =
            $root.oracle_job.OracleJob.LpTokenPriceTask.toObject(
              message.lpTokenPriceTask,
              options
            );
        ...
        if (
          ...
          object.lpExchangeRateTask =
            $root.oracle_job.OracleJob.LpExchangeRateTask.toObject(
              message.lpExchangeRateTask,
              options
            );
        ...
        if (
          ...
          object.conditionalTask =
            $root.oracle_job.OracleJob.ConditionalTask.toObject(
              message.conditionalTask,
              options
            );
        ...
        if (message.valueTask != null && message.hasOwnProperty("valueTask")) {
          object.valueTask = $root.oracle_job.OracleJob.ValueTask.toObject(
            message.valueTask,
            options
          );
        ...
        if (message.maxTask != null && message.hasOwnProperty("maxTask")) {
          object.maxTask = $root.oracle_job.OracleJob.MaxTask.toObject(
            message.maxTask,
            options
          );
        ...
        if (
          ...
          object.regexExtractTask =
            $root.oracle_job.OracleJob.RegexExtractTask.toObject(
              message.regexExtractTask,
              options
            );
        ...
        if (
          ...
          object.xstepPriceTask =
            $root.oracle_job.OracleJob.XStepPriceTask.toObject(
              message.xstepPriceTask,
              options
            );
        ...
        if (message.addTask != null && message.hasOwnProperty("addTask")) {
          object.addTask = $root.oracle_job.OracleJob.AddTask.toObject(
            message.addTask,
            options
          );
        ...
        if (
          ...
          object.subtractTask =
            $root.oracle_job.OracleJob.SubtractTask.toObject(
              message.subtractTask,
              options
            );
        ...
        if (message.twapTask != null && message.hasOwnProperty("twapTask")) {
          object.twapTask = $root.oracle_job.OracleJob.TwapTask.toObject(
            message.twapTask,
            options
          );
        ...
        if (
          ...
          object.serumSwapTask =
            $root.oracle_job.OracleJob.SerumSwapTask.toObject(
              message.serumSwapTask,
              options
            );
        ...
        if (message.powTask != null && message.hasOwnProperty("powTask")) {
          object.powTask = $root.oracle_job.OracleJob.PowTask.toObject(
            message.powTask,
            options
          );
        ...
        if (
          ...
          object.lendingRateTask =
            $root.oracle_job.OracleJob.LendingRateTask.toObject(
              message.lendingRateTask,
              options
            );
        ...
        if (
          ...
          object.mangoPerpMarketTask =
            $root.oracle_job.OracleJob.MangoPerpMarketTask.toObject(
              message.mangoPerpMarketTask,
              options
            );
        ...
        if (
          ...
          object.jupiterSwapTask =
            $root.oracle_job.OracleJob.JupiterSwapTask.toObject(
              message.jupiterSwapTask,
              options
            );
        ...
        if (
          ...
          object.perpMarketTask =
            $root.oracle_job.OracleJob.PerpMarketTask.toObject(
              message.perpMarketTask,
              options
            );
        ...
        if (
          ...
          object.oracleTask = $root.oracle_job.OracleJob.OracleTask.toObject(
            message.oracleTask,
            options
          );
        ...
        if (
          ...
          object.anchorFetchTask =
            $root.oracle_job.OracleJob.AnchorFetchTask.toObject(
              message.anchorFetchTask,
              options
            );
        ...
        if (
          ...
          object.splStakePoolTask =
            $root.oracle_job.OracleJob.SplStakePoolTask.toObject(
              message.splStakePoolTask,
              options
            );
        ...
        if (
          ...
          object.splTokenParseTask =
            $root.oracle_job.OracleJob.SplTokenParseTask.toObject(
              message.splTokenParseTask,
              options
            );
        ...
        if (
          ...
          object.uniswapExchangeRateTask =
            $root.oracle_job.OracleJob.UniswapExchangeRateTask.toObject(
              message.uniswapExchangeRateTask,
              options
            );
        ...
        if (
          ...
          object.sushiswapExchangeRateTask =
            $root.oracle_job.OracleJob.SushiswapExchangeRateTask.toObject(
              message.sushiswapExchangeRateTask,
              options
            );
        ...
        if (
          ...
          object.pancakeswapExchangeRateTask =
            $root.oracle_job.OracleJob.PancakeswapExchangeRateTask.toObject(
              message.pancakeswapExchangeRateTask,
              options
            );
        ...
        if (message.cacheTask != null && message.hasOwnProperty("cacheTask")) {
          object.cacheTask = $root.oracle_job.OracleJob.CacheTask.toObject(
            message.cacheTask,
            options
          );
        ...
        if (
          ...
          object.sysclockOffsetTask =
            $root.oracle_job.OracleJob.SysclockOffsetTask.toObject(
              message.sysclockOffsetTask,
              options
            );
        ...
        if (
          ...
          object.marinadeStateTask =
            $root.oracle_job.OracleJob.MarinadeStateTask.toObject(
              message.marinadeStateTask,
              options
            );
        ...
        if (
          ...
          object.solanaAccountDataFetchTask =
            $root.oracle_job.OracleJob.SolanaAccountDataFetchTask.toObject(
              message.solanaAccountDataFetchTask,
              options
            );
        ...
        if (
          ...
          object.bufferLayoutParseTask =
            $root.oracle_job.OracleJob.BufferLayoutParseTask.toObject(
              message.bufferLayoutParseTask,
              options
            );
        ...
        if (message.minTask != null && message.hasOwnProperty("minTask")) {
          object.minTask = $root.oracle_job.OracleJob.MinTask.toObject(
            message.minTask,
            options
          );
        ...
        if (
          ...
          object.historyFunctionTask =
            $root.oracle_job.OracleJob.HistoryFunctionTask.toObject(
              message.historyFunctionTask,
              options
            );
        ...
        if (message.vwapTask != null && message.hasOwnProperty("vwapTask")) {
          object.vwapTask = $root.oracle_job.OracleJob.VwapTask.toObject(
            message.vwapTask,
            options
          );
        ...
        if (message.ewmaTask != null && message.hasOwnProperty("ewmaTask")) {
          object.ewmaTask = $root.oracle_job.OracleJob.EwmaTask.toObject(
            message.ewmaTask,
            options
          );
        ...
        if (
          ...
          object.comparisonTask =
            $root.oracle_job.OracleJob.ComparisonTask.toObject(
              message.comparisonTask,
              options
            );
        ...
        if (message.roundTask != null && message.hasOwnProperty("roundTask")) {
          object.roundTask = $root.oracle_job.OracleJob.RoundTask.toObject(
            message.roundTask,
            options
          );
        ...
        if (message.boundTask != null && message.hasOwnProperty("boundTask")) {
          object.boundTask = $root.oracle_job.OracleJob.BoundTask.toObject(
            message.boundTask,
            options
          );
        ...
        if (
          ...
          object.secretsTask = $root.oracle_job.OracleJob.SecretsTask.toObject(
            message.secretsTask,
            options
          );
          if (options.oneofs) object.Task = "secretsTask";
        }
        if (
          message.sanctumLstPriceTask != null &&
          message.hasOwnProperty("sanctumLstPriceTask")
          ...
          object.sanctumLstPriceTask =
            $root.oracle_job.OracleJob.SanctumLstPriceTask.toObject(
              message.sanctumLstPriceTask,
              options
            );
          if (options.oneofs) object.Task = "sanctumLstPriceTask";
        }
        if (
          message.ondoUsdyTask != null &&
          message.hasOwnProperty("ondoUsdyTask")
          ...
          object.ondoUsdyTask =
            $root.oracle_job.OracleJob.OndoUsdyTask.toObject(
              message.ondoUsdyTask,
              options
            );
          if (options.oneofs) object.Task = "ondoUsdyTask";
        }
        if (
          message.meteoraSwapTask != null &&
          message.hasOwnProperty("meteoraSwapTask")
          ...
          object.meteoraSwapTask =
            $root.oracle_job.OracleJob.MeteoraSwapTask.toObject(
              message.meteoraSwapTask,
              options
            );
          if (options.oneofs) object.Task = "meteoraSwapTask";
        }
        return object;
      };
