...
// Module: Proofs.HealthInvariants
// Imports: Init MangoState QEDGen.Solana Mathlib.Tactic.SplitIfs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Proofs_HealthInvariants(uint8_t builtin, lean_object* w) {
lean_object * res;
